...
.method public static final getDinnerDining(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "Sharp.DinnerDining"
    ...
    .local v24, "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v25, 0x0

    .line 31
    .local v25, "$i$a$-materialPath-YwgOQQI$default-DinnerDiningKt$DinnerDining$1$1":I
    move/from16 v28, v6
    ...
    .end local v24    # "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v25    # "$i$a$-materialPath-YwgOQQI$default-DinnerDiningKt$DinnerDining$1$1":I
    nop
    ...
    .local v9, "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .local v38, "$this$_get_DinnerDining__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v9    # "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v31, "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 42
    const v36, -0x3f5b851f    # -5.14f

    const v37, 0x40633333    # 3.55f
    ...
    .end local v31    # "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v33, 0x4186cccd    # 16.85f

    const v34, 0x404e147b    # 3.22f

    const v35, 0x418b1eb8    # 17.39f

    .end local v0    # "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v31    # "$this$_get_DinnerDining__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v31 .. v37}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v38    # "$this$_get_DinnerDining__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
