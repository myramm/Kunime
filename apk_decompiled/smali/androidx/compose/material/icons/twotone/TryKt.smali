...
.method public static final getTry(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "TwoTone.Try"
    ...
    .line 30
    .local v3, "$i$a$-materialIcon$default-TryKt$Try$1":I
    ...
    .local v24, "$this$_get_Try__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v25, 0x0

    .line 31
    .local v25, "$i$a$-materialPath-YwgOQQI$default-TryKt$Try$1$1":I
    move/from16 v28, v6
    ...
    .end local v24    # "$this$_get_Try__u24lambda_u243_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v25    # "$i$a$-materialPath-YwgOQQI$default-TryKt$Try$1$1":I
    nop
    ...
    .local v9, "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .local v39, "$this$_get_Try__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v9    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v31, "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v31    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v0    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v31    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 57
    .end local v31    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v0    # "$this$_get_Try__u24lambda_u243_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/high16 v9, 0x40800000    # 4.0f
    ...
    .local v8, "$this$_get_Try__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v9, 0x0

    .line 69
    .local v9, "$i$a$-materialPath-YwgOQQI$default-TryKt$Try$1$3":I
    ...
    .line 197
    .end local v8    # "$this$_get_Try__u24lambda_u243_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v9    # "$i$a$-materialPath-YwgOQQI$default-TryKt$Try$1$3":I
    nop
    ...
    .line 96
    .end local v3    # "$i$a$-materialIcon$default-TryKt$Try$1":I
    .end local v39    # "$this$_get_Try__u24lambda_u243":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
