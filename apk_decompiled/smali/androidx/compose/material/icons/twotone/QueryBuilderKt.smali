...
.method public static final getQueryBuilder(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "TwoTone.QueryBuilder"
    ...
    .line 30
    .local v3, "$i$a$-materialIcon$default-QueryBuilderKt$QueryBuilder$1":I
    ...
    .local v24, "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v31, 0x0

    .line 31
    .local v31, "$i$a$-materialPath-YwgOQQI$default-QueryBuilderKt$QueryBuilder$1$1":I
    move/from16 v32, v6
    ...
    .end local v24    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v0    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v24    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 33
    .end local v24    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v0    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v30, "$this$_get_QueryBuilder__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 109
    .end local v0    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v31    # "$i$a$-materialPath-YwgOQQI$default-QueryBuilderKt$QueryBuilder$1$1":I
    nop
    ...
    .local v8, "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .end local v8    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v34, "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 49
    .end local v34    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v8    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v8    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v34    # "$this$_get_QueryBuilder__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v34 .. v40}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v8, v0, v9, v1, v9}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 84
    .end local v3    # "$i$a$-materialIcon$default-QueryBuilderKt$QueryBuilder$1":I
    .end local v30    # "$this$_get_QueryBuilder__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
