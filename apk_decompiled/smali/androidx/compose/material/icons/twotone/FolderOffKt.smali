...
.method public static final getFolderOff(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "TwoTone.FolderOff"
    ...
    .local v24, "$this$_get_FolderOff__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v25, 0x0

    .line 31
    .local v25, "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$1":I
    move/from16 v28, v6
    ...
    .end local v24    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v25    # "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$1":I
    nop
    ...
    .local v12, "$this$_get_FolderOff__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v13, 0x0

    .line 37
    .local v13, "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$2":I
    ...
    invoke-virtual {v12, v9, v15}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 39
    const v9, -0x3eed47ae    # -9.17f
    ...
    .line 154
    .end local v12    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$2":I
    nop
    ...
    .local v9, "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v11, 0x0

    .line 43
    .local v11, "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$3":I
    ...
    .end local v9    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v16, "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 46
    .end local v16    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v9    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v9    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v16    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v14, v14}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 192
    .end local v9    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v11    # "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$3":I
    nop
    ...
    .local v14, "$this$_get_FolderOff__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v9, 0x0

    .line 61
    .local v9, "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$4":I
    const/high16 v11, 0x40c00000    # 6.0f

    const/high16 v12, 0x41a00000    # 20.0f

    invoke-virtual {v14, v12, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 62
    const/high16 v11, -0x3f000000    # -8.0f

    invoke-virtual {v14, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->horizontalLineToRelative(F)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 63
    const/high16 v11, -0x40000000    # -2.0f

    invoke-virtual {v14, v11, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 64
    const v11, 0x40e570a4    # 7.17f

    invoke-virtual {v14, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->horizontalLineTo(F)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 65
    invoke-virtual {v14, v13, v13}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v14, v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->verticalLineTo(F)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 230
    .end local v9    # "$i$a$-materialPath-YwgOQQI$default-FolderOffKt$FolderOff$1$4":I
    .end local v14    # "$this$_get_FolderOff__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    nop
