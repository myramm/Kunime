...
.method public static final getIntegrationInstructions(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "TwoTone.IntegrationInstructions"
    ...
    .local v12, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v23, 0x0
    ...
    .local v29, "$this$_get_IntegrationInstructions__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 134
    .end local v12    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v8, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v9, 0x0
    ...
    .line 172
    .end local v8    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v8, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v9, 0x0
    ...
    .end local v8    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v30, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v30    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v0    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v30    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v30 .. v36}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 58
    .end local v30    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v0    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 243
    .local v43, "name$iv$iv":Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .local v7, "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v8, 0x0

    .line 86
    .local v8, "$i$a$-materialPath-YwgOQQI$default-IntegrationInstructionsKt$IntegrationInstructions$1$4":I
    ...
    .line 248
    .end local v7    # "$this$_get_IntegrationInstructions__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v8    # "$i$a$-materialPath-YwgOQQI$default-IntegrationInstructionsKt$IntegrationInstructions$1$4":I
    nop
    ...
    .end local v43    # "name$iv$iv":Ljava/lang/String;
    ...
    .end local v0    # "$this$materialPath_u2dYwgOQQI_u24default$iv":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v1    # "$i$f$materialPath-YwgOQQI":I
    .end local v42    # "pathFillType$iv":I
    ...
    .end local v29    # "$this$_get_IntegrationInstructions__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
