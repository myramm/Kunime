...
.method public static final getAdUnits(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string/jumbo v2, "TwoTone.AdUnits"
    ...
    .local v24, "$this$_get_AdUnits__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v25, 0x0

    .line 31
    .local v25, "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$1":I
    ...
    .end local v24    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v25    # "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$1":I
    nop
    ...
    .local v12, "$this$_get_AdUnits__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v13, 0x0

    .line 38
    .local v13, "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$2":I
    ...
    .line 166
    .end local v12    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$2":I
    nop
    ...
    .local v12, "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v23, 0x0

    .line 45
    .local v23, "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$3":I
    ...
    .end local v12    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v31, "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v31    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .restart local v31    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 50
    .end local v31    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v0    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 204
    .end local v0    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v23    # "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$3":I
    nop
    ...
    .local v9, "$this$_get_AdUnits__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 79
    .local v12, "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$4":I
    ...
    .local v29, "$this$_get_AdUnits__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .line 242
    .end local v9    # "$this$_get_AdUnits__u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-AdUnitsKt$AdUnits$1$4":I
    nop
    ...
    .end local v29    # "$this$_get_AdUnits__u24lambda_u244":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
