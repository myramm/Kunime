...
.method private static final detectZoom(Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;ZLkotlinx/coroutines/channels/Channel;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v14, "canPan":Lkotlin/jvm/functions/Function1;
    :goto_3
    ...
    .line 219
    .local v22, "$i$a$-fastAny-TransformableKt$detectZoom$canceled$1":I
    ...
    .end local v22    # "$i$a$-fastAny-TransformableKt$detectZoom$canceled$1":I
    if-eqz v21, :cond_3
    ...
    .end local p3    # "lockedToPanZoom":Z
    .local v3, "lockedToPanZoom":Z
    ...
    .end local p0    # "$this$fastForEach$iv$iv":Ljava/util/List;
    .local v3, "$this$fastForEach$iv$iv":Ljava/util/List;
    .restart local p3    # "lockedToPanZoom":Z
    nop
    ...
    .line 223
    .local v3, "rotationChange":F
    move v15, v3

    move/from16 p0, v4

    .end local v3    # "rotationChange":F
    .end local v4    # "pastTouchSlop":Z
    .local v15, "rotationChange":F
    .local p0, "pastTouchSlop":Z
    ...
    .end local v7    # "pan":J
    .local v18, "pan":J
    invoke-static {v0, v7}, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt;->calculateCentroidSize(Landroidx/compose/ui/input/pointer/PointerEvent;Z)F

    move-result v8

    .line 231
    .local v8, "centroidSize":F
    sub-float v20, v17, v9
    ...
    .line 235
    .local v21, "panMotion":F
    cmpl-float v22, v20, v5

    if-gtz v22, :cond_6

    .line 236
    .end local v20    # "zoomMotion":F
    cmpl-float v20, v8, v5

    if-gtz v20, :cond_6

    .line 237
    cmpl-float v20, v21, v5
    ...
    .restart local p0    # "pastTouchSlop":Z
    ...
    invoke-interface {v12, v7}, Lkotlinx/coroutines/channels/Channel;->trySend-JP2dKIU(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 247
    .end local v15    # "rotationChange":F
    .local v19, "effectiveRotation":F
    :goto_9
    cmpg-float v15, v19, v18
    ...
    .restart local p3    # "pastTouchSlop":Z
    :goto_c
    new-instance v15, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;
    ...
    .local v17, "panChange":J
    invoke-direct/range {v15 .. v20}, Landroidx/compose/foundation/gestures/TransformEvent$TransformDelta;-><init>(FJFLkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-interface {v12, v15}, Lkotlinx/coroutines/channels/Channel;->trySend-JP2dKIU(Ljava/lang/Object;)Ljava/lang/Object;

    .line 253
    .end local v16    # "zoomChange":F
    .end local v17    # "panChange":J
    .end local v19    # "effectiveRotation":F
    :cond_e
    invoke-virtual {v0}, Landroidx/compose/ui/input/pointer/PointerEvent;->getChanges()Ljava/util/List;
    ...
    .line 254
    .local v16, "$i$a$-fastForEach-TransformableKt$detectZoom$2":I
    ...
    .line 290
    .end local v16    # "$i$a$-fastForEach-TransformableKt$detectZoom$2":I
    nop
    ...
    .line 260
    .end local v21    # "zoom":F
    .end local v22    # "rotation":F
    .end local p0    # "lockedToPanZoom":Z
    .local v4, "pastTouchSlop":Z
    .local v7, "pan":J
    .local v9, "zoom":F
    ...
    iput-object v14, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->L$2:Ljava/lang/Object;

    iput-object v0, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->L$3:Ljava/lang/Object;

    iput-boolean v11, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->Z$0:Z

    iput v8, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->F$0:F
    ...
    iput v1, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->I$2:I

    move-object/from16 p0, v0

    .end local v0    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    .local p0, "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    const/4 v0, 0x3

    iput v0, v6, Landroidx/compose/foundation/gestures/TransformableKt$detectZoom$1;->label:I

    invoke-interface {v13, v15, v6}, Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;->awaitPointerEvent(Landroidx/compose/ui/input/pointer/PointerEventPass;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 205
    .end local p0    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    ...
    .local v15, "$this$detectZoom":Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;
    ...
    .line 265
    .local v20, "$i$a$-fastAny-TransformableKt$detectZoom$3":I
    ...
    .end local v20    # "$i$a$-fastAny-TransformableKt$detectZoom$3":I
    if-eqz v19, :cond_17
    ...
    .end local v14    # "canPan":Lkotlin/jvm/functions/Function1;
    .end local v15    # "$this$detectZoom":Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;
    :cond_1a
    :goto_16
