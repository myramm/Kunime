...
.method private final drawGenericBorder(Landroidx/compose/ui/draw/CacheDrawScope;Landroidx/compose/ui/graphics/Brush;Landroidx/compose/ui/graphics/Outline$Generic;ZF)Landroidx/compose/ui/draw/DrawResult;
    ...
    .local v9, "it$iv":Landroidx/compose/ui/graphics/ImageBitmap;
    const/4 v10, 0x0

    .line 534
    .local v10, "$i$a$-also-BorderCache$drawBorderCache$1$iv":I
    invoke-static {v6, v9}, Landroidx/compose/foundation/BorderCache;->access$setImageBitmap$p(Landroidx/compose/foundation/BorderCache;Landroidx/compose/ui/graphics/ImageBitmap;)V

    .line 535
    nop

    .line 533
    .end local v9    # "it$iv":Landroidx/compose/ui/graphics/ImageBitmap;
    .end local v10    # "$i$a$-also-BorderCache$drawBorderCache$1$iv":I
    nop
    ...
    .local v9, "it$iv":Landroidx/compose/ui/graphics/Canvas;
    const/4 v10, 0x0

    .line 537
    .local v10, "$i$a$-also-BorderCache$drawBorderCache$2$iv":I
    invoke-static {v6, v9}, Landroidx/compose/foundation/BorderCache;->access$setCanvas$p(Landroidx/compose/foundation/BorderCache;Landroidx/compose/ui/graphics/Canvas;)V

    .line 538
    nop

    .line 536
    .end local v9    # "it$iv":Landroidx/compose/ui/graphics/Canvas;
    .end local v10    # "$i$a$-also-BorderCache$drawBorderCache$2$iv":I
    move-object v7, v8
    ...
    .local v13, "targetImageBitmap$iv":Landroidx/compose/ui/graphics/ImageBitmap;
    .local v14, "targetCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    :goto_4
    ...
    .line 544
    .local v16, "targetDrawScope$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    ...
    .local v17, "this_$iv$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    const/16 v18, 0x0
    ...
    .local v19, "this_$iv":Landroidx/compose/foundation/BorderCache;
    ...
    .local v42, "prevDensity$iv$iv":Landroidx/compose/ui/unit/Density;
    .local v43, "prevLayoutDirection$iv$iv":Landroidx/compose/ui/unit/LayoutDirection;
    ...
    .line 550
    .local v29, "$i$a$-apply-CanvasDrawScope$draw$1$iv$iv":I
    ...
    .end local v29    # "$i$a$-apply-CanvasDrawScope$draw$1$iv$iv":I
    nop
    ...
    .local v29, "$this$drawBorderCache_EMwLDEs_u24lambda_u243$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v1, 0x0

    .line 557
    .local v1, "$i$a$-draw-yzxVdVo-BorderCache$drawBorderCache$3$iv":I
    nop
    ...
    .local v34, "drawSize$iv":J
    invoke-static/range {v29 .. v41}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->drawRect-n-J9OG0$default(Landroidx/compose/ui/graphics/drawscope/DrawScope;JJJFLandroidx/compose/ui/graphics/drawscope/DrawStyle;Landroidx/compose/ui/graphics/ColorFilter;IILjava/lang/Object;)V
    ...
    .local v32, "$this$translate$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    move v8, v0
    ...
    invoke-interface/range {v32 .. v32}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .line 273
    .local v37, "$i$a$-translate-BorderModifierNode$drawGenericBorder$2$1$1":I
    nop
    ...
    .local v38, "cacheImageBitmap":Lkotlin/jvm/internal/Ref$ObjectRef;
    :try_start_0
    invoke-virtual {v12}, Landroidx/compose/ui/graphics/Outline$Generic;->getPath()Landroidx/compose/ui/graphics/Path;
    ...
    .line 276
    new-instance v44, Landroidx/compose/ui/graphics/drawscope/Stroke;
    ...
    invoke-direct/range {v44 .. v51}, Landroidx/compose/ui/graphics/drawscope/Stroke;-><init>(FFIILandroidx/compose/ui/graphics/PathEffect;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    check-cast v44, Landroidx/compose/ui/graphics/drawscope/DrawStyle;
    :try_end_0
    ...
    .local v41, "prevCanvas$iv$iv":Landroidx/compose/ui/graphics/Canvas;
    const/4 v6, 0x0
    ...
    .end local v45    # "top$iv":F
    .local v1, "top$iv":F
    .local v12, "prevDensity$iv$iv":Landroidx/compose/ui/unit/Density;
    .local v13, "left$iv":F
    ...
    .local v19, "$i$a$-draw-yzxVdVo-BorderCache$drawBorderCache$3$iv":I
    .local v38, "this_$iv":Landroidx/compose/foundation/BorderCache;
    .local v39, "targetCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .local v40, "config":I
    .local v41, "cacheImageBitmap":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 566
    .local v45, "$this$scale_u2dFgt4K4Q_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    nop

    .line 569
    invoke-interface/range {v45 .. v45}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getCenter-F1C5BW0()J
    ...
    .line 571
    .local v47, "$i$f$scale-Fgt4K4Q":I
    move-object/from16 v48, v45

    .local v48, "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/16 v49, 0x0

    .line 572
    .local v49, "$i$f$withTransform":I
    invoke-interface/range {v48 .. v48}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->getDrawContext()Landroidx/compose/ui/graphics/drawscope/DrawContext;
    ...
    .end local v10    # "scaleX$iv":F
    .local v51, "scaleX$iv":F
    const/16 v10, 0x1c
    ...
    .line 571
    .end local v48    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v49    # "$i$f$withTransform":I
    nop

    .line 288
    .end local v21    # "scaleY$iv":F
    .end local v45    # "$this$scale_u2dFgt4K4Q_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v47    # "$i$f$scale-Fgt4K4Q":I
    .end local v51    # "scaleX$iv":F
    ...
    .end local v37    # "$i$a$-translate-BorderModifierNode$drawGenericBorder$2$1$1":I
    nop
    ...
    .end local v32    # "$this$translate$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    .line 556
    .end local v19    # "$i$a$-draw-yzxVdVo-BorderCache$drawBorderCache$3$iv":I
    .end local v29    # "$this$drawBorderCache_EMwLDEs_u24lambda_u243$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    nop
    ...
    .end local v43    # "prevSize$iv$iv":J
    ...
    .end local v12    # "prevDensity$iv$iv":Landroidx/compose/ui/unit/Density;
    .end local v17    # "this_$iv$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    ...
    .line 263
    .end local v16    # "targetDrawScope$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    ...
    .end local v34    # "drawSize$iv":J
    .end local v38    # "this_$iv":Landroidx/compose/foundation/BorderCache;
    ...
    .end local v41    # "cacheImageBitmap":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .restart local v41    # "cacheImageBitmap":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .restart local v12    # "prevDensity$iv$iv":Landroidx/compose/ui/unit/Density;
    .restart local v13    # "left$iv":F
    .restart local v16    # "targetDrawScope$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    .restart local v17    # "this_$iv$iv":Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;
    .restart local v18    # "$i$f$draw-yzxVdVo":I
    .restart local v19    # "$i$a$-draw-yzxVdVo-BorderCache$drawBorderCache$3$iv":I
    .restart local v20    # "colorFilter":Landroidx/compose/ui/graphics/ColorFilter;
    ...
    .restart local v29    # "$this$drawBorderCache_EMwLDEs_u24lambda_u243$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v30    # "$this$drawGenericBorder_u24lambda_u244_u24lambda_u243":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v31    # "$i$a$-drawBorderCache-EMwLDEs-BorderModifierNode$drawGenericBorder$2$1":I
    .restart local v32    # "$this$translate$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v33    # "$i$f$translate":I
    .restart local v34    # "drawSize$iv":J
    .restart local v36    # "pathBounds":Landroidx/compose/ui/geometry/Rect;
    .restart local v38    # "this_$iv":Landroidx/compose/foundation/BorderCache;
    .restart local v39    # "targetCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .restart local v40    # "config":I
    .restart local v41    # "cacheImageBitmap":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v42    # "targetImageBitmap$iv":Landroidx/compose/ui/graphics/ImageBitmap;
    .restart local v43    # "prevSize$iv$iv":J
    ...
    .restart local v21    # "scaleY$iv":F
    .restart local v22    # "pathBoundsSize":J
    .restart local v37    # "$i$a$-translate-BorderModifierNode$drawGenericBorder$2$1$1":I
    .restart local v42    # "targetImageBitmap$iv":Landroidx/compose/ui/graphics/ImageBitmap;
    .restart local v43    # "prevSize$iv$iv":J
    .restart local v45    # "$this$scale_u2dFgt4K4Q_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v47    # "$i$f$scale-Fgt4K4Q":I
    .restart local v48    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v49    # "$i$f$withTransform":I
    .restart local v50    # "$i$a$-with-DrawScopeKt$withTransform$1$iv$iv":I
    .restart local v51    # "scaleX$iv":F
    ...
    .end local v7    # "left$iv":F
    .end local v14    # "targetCanvas$iv":Landroidx/compose/ui/graphics/Canvas;
    .end local v15    # "config":I
    .end local v21    # "maskPath":Landroidx/compose/ui/graphics/Path;
    .end local v22    # "pathBoundsSize":J
    .end local v42    # "prevDensity$iv$iv":Landroidx/compose/ui/unit/Density;
    .end local v43    # "prevLayoutDirection$iv$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .local v1, "top$iv":F
    .restart local v3    # "prevLayoutDirection$iv$iv":Landroidx/compose/ui/unit/LayoutDirection;
    .restart local v4    # "prevCanvas$iv$iv":Landroidx/compose/ui/graphics/Canvas;
    .local v6, "prevSize$iv$iv":J
