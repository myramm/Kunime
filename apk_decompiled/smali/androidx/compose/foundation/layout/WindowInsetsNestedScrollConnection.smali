...
.method private final fling-huYlsQE(JFZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v0, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->result:Ljava/lang/Object;
    ...
    .line 303
    iget v4, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->label:I
    ...
    :pswitch_0
    iget-wide v3, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->J$0:J

    .local v3, "available":J
    iget-object v5, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->L$0:Ljava/lang/Object;
    ...
    iget-object v5, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->L$1:Ljava/lang/Object;
    ...
    :pswitch_2
    iget v4, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->F$0:F

    .local v4, "flingAmount":F
    iget-wide v9, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->J$0:J

    .local v9, "available":J
    iget-object v11, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->L$0:Ljava/lang/Object;
    ...
    .restart local v11    # "this":Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;
    move/from16 v4, p4

    .local v4, "towardShown":Z
    move-wide/from16 v9, p1

    .restart local v9    # "available":J
    move/from16 v12, p3

    .line 308
    .local v12, "flingAmount":F
    iget-object v13, v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->animationJob:Lkotlinx/coroutines/Job;
    ...
    .line 309
    :cond_1
    iput-object v5, v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->animationJob:Lkotlinx/coroutines/Job;

    .line 310
    iput v7, v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->partialConsumption:F
    ...
    .line 313
    :cond_3
    iget-object v13, v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->animationController:Landroid/view/WindowInsetsAnimationController;

    if-nez v13, :cond_5

    iget-object v13, v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->windowInsets:Landroidx/compose/foundation/layout/AndroidWindowInsets;
    ...
    :cond_5
    iput-object v11, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->L$0:Ljava/lang/Object;

    iput-wide v9, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->J$0:J

    iput v12, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->F$0:F

    iput v8, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->label:I

    invoke-direct {v11, v1}, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->getAnimationController(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v14, "flingAmount":F
    :goto_2
    move-object/from16 v16, v4

    check-cast v16, Landroid/view/WindowInsetsAnimationController;

    if-nez v16, :cond_7

    .end local v9    # "available":J
    .end local v12    # "this":Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;
    .end local v14    # "flingAmount":F
    sget-object v3, Landroidx/compose/ui/unit/Velocity;->Companion:Landroidx/compose/ui/unit/Velocity$Companion;
    ...
    .restart local v14    # "flingAmount":F
    :cond_7
    move-object/from16 v4, v16

    .line 322
    .local v4, "animationController":Landroid/view/WindowInsetsAnimationController;
    iget-object v11, v12, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->sideCalculator:Landroidx/compose/foundation/layout/SideCalculator;

    invoke-interface {v4}, Landroid/view/WindowInsetsAnimationController;->getHiddenStateInsets()Landroid/graphics/Insets;

    move-result-object v13

    invoke-interface {v11, v13}, Landroidx/compose/foundation/layout/SideCalculator;->valueOf(Landroid/graphics/Insets;)I

    move-result v11

    .line 323
    .local v11, "hidden":I
    iget-object v13, v12, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->sideCalculator:Landroidx/compose/foundation/layout/SideCalculator;

    invoke-interface {v4}, Landroid/view/WindowInsetsAnimationController;->getShownStateInsets()Landroid/graphics/Insets;

    move-result-object v15

    invoke-interface {v13, v15}, Landroidx/compose/foundation/layout/SideCalculator;->valueOf(Landroid/graphics/Insets;)I
    ...
    iget-object v6, v12, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->sideCalculator:Landroidx/compose/foundation/layout/SideCalculator;
    ...
    .end local v4    # "animationController":Landroid/view/WindowInsetsAnimationController;
    .end local v6    # "current":I
    .end local v13    # "shown":I
    :goto_3
    invoke-interface {v4, v6}, Landroid/view/WindowInsetsAnimationController;->finish(Z)V

    .line 330
    iput-object v5, v12, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->animationController:Landroid/view/WindowInsetsAnimationController;
    ...
    .line 335
    .restart local v4    # "animationController":Landroid/view/WindowInsetsAnimationController;
    .restart local v6    # "current":I
    .restart local v9    # "available":J
    .restart local v11    # "hidden":I
    .restart local v12    # "this":Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;
    .restart local v13    # "shown":I
    .restart local v14    # "flingAmount":F
    :cond_b
    new-instance v15, Landroidx/compose/foundation/layout/SplineBasedFloatDecayAnimationSpec;

    iget-object v5, v12, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->density:Landroidx/compose/ui/unit/Density;

    invoke-direct {v15, v5}, Landroidx/compose/foundation/layout/SplineBasedFloatDecayAnimationSpec;-><init>(Landroidx/compose/ui/unit/Density;)V

    .line 336
    .local v15, "spec":Landroidx/compose/foundation/layout/SplineBasedFloatDecayAnimationSpec;
    int-to-float v5, v6

    invoke-virtual {v15, v14}, Landroidx/compose/foundation/layout/SplineBasedFloatDecayAnimationSpec;->flingDistance(F)F
    ...
    .end local v11    # "hidden":I
    .end local v13    # "shown":I
    .end local v15    # "spec":Landroidx/compose/foundation/layout/SplineBasedFloatDecayAnimationSpec;
    :cond_e
    new-instance v11, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$3;
    ...
    .local v16, "animationController":Landroid/view/WindowInsetsAnimationController;
    invoke-direct/range {v11 .. v18}, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$3;-><init>(Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;IIFLandroid/view/WindowInsetsAnimationController;ZLkotlin/coroutines/Continuation;)V

    .end local v13    # "current":I
    .end local v14    # "target":I
    .end local v15    # "flingAmount":F
    .end local v16    # "animationController":Landroid/view/WindowInsetsAnimationController;
    ...
    .local v5, "this":Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;
    :goto_7
    iget-object v0, v5, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection;->sideCalculator:Landroidx/compose/foundation/layout/SideCalculator;

    const/4 v6, 0x0

    invoke-interface {v0, v3, v4, v6}, Landroidx/compose/foundation/layout/SideCalculator;->consumedVelocity-QWom1Mo(JF)J
    ...
    .local v5, "distance":F
    .restart local v6    # "current":I
    .restart local v7    # "targetShown":Z
    ...
    .line 346
    .local v18, "endVelocity":Lkotlin/jvm/internal/Ref$FloatRef;
    move/from16 v16, v11
    ...
    .end local v16    # "hidden":I
    .end local v17    # "shown":I
    .end local v18    # "endVelocity":Lkotlin/jvm/internal/Ref$FloatRef;
    .end local v19    # "animationController":Landroid/view/WindowInsetsAnimationController;
    .local v5, "endVelocity":Lkotlin/jvm/internal/Ref$FloatRef;
    check-cast v11, Lkotlin/jvm/functions/Function2;
    ...
    iput-object v5, v1, Landroidx/compose/foundation/layout/WindowInsetsNestedScrollConnection$fling$1;->L$1:Ljava/lang/Object;
    ...
    invoke-interface {v0, v3, v4, v7}, Landroidx/compose/foundation/layout/SideCalculator;->consumedVelocity-QWom1Mo(JF)J
