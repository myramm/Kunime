...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v4, "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    :try_start_0
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    :try_end_0
    ...
    .line 371
    .end local v4    # "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_3
    move-object v0, p0
    ...
    .restart local v0    # "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v4, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$1:Ljava/lang/Object;

    check-cast v4, Landroidx/compose/animation/core/AnimationSpec;

    .local v4, "spec":Landroidx/compose/animation/core/AnimationSpec;
    iget-object v5, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$0:Ljava/lang/Object;
    ...
    .restart local v0    # "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v4, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$0:Ljava/lang/Object;
    ...
    .line 376
    :cond_0
    iget-object v4, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->this$0:Landroidx/compose/foundation/MarqueeModifierNode;
    ...
    iget-object v6, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->this$0:Landroidx/compose/foundation/MarqueeModifierNode;
    ...
    iput-object v5, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$0:Ljava/lang/Object;

    iput-object v4, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$1:Ljava/lang/Object;

    const/4 v9, 0x1

    iput v9, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->label:I
    ...
    .end local v5    # "contentWithSpacingWidth":Ljava/lang/Float;
    .local v4, "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    .local v6, "contentWithSpacingWidth":Ljava/lang/Float;
    .local v7, "spec":Landroidx/compose/animation/core/AnimationSpec;
    :goto_0
    nop

    .line 386
    :try_start_1
    iget-object v0, v4, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->this$0:Landroidx/compose/foundation/MarqueeModifierNode;
    ...
    iput-object v2, v4, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$0:Ljava/lang/Object;

    iput-object v2, v4, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$1:Ljava/lang/Object;

    const/4 v0, 0x2

    iput v0, v4, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->label:I
    ...
    .end local v6    # "contentWithSpacingWidth":Ljava/lang/Float;
    .end local v7    # "spec":Landroidx/compose/animation/core/AnimationSpec;
    if-ne v0, v1, :cond_2
    ...
    .restart local v0    # "this":Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;
    :goto_1
    iget-object v2, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->this$0:Landroidx/compose/foundation/MarqueeModifierNode;
    ...
    iput v5, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->label:I
    ...
    .line 390
    :goto_3
    iget-object v5, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->this$0:Landroidx/compose/foundation/MarqueeModifierNode;
    ...
    iput-object v4, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$0:Ljava/lang/Object;

    iput-object v2, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->L$1:Ljava/lang/Object;

    const/4 v2, 0x4

    iput v2, v0, Landroidx/compose/foundation/MarqueeModifierNode$runAnimation$2$2;->label:I
