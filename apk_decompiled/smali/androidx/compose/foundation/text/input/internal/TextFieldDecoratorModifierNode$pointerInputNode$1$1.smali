...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode$pointerInputNode$1$1;->L$0:Ljava/lang/Object;
    ...
    iget-object v1, v0, Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode$pointerInputNode$1$1;->this$0:Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode;
    ...
    .local v1, "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    iget-object v8, v0, Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode$pointerInputNode$1$1;->this$0:Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode;

    iget-object v9, v0, Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode$pointerInputNode$1$1;->$$this$SuspendingPointerInputModifierNode:Landroidx/compose/ui/input/pointer/PointerInputScope;

    const/4 v10, 0x0

    .line 203
    .local v10, "$i$a$-with-TextFieldDecoratorModifierNode$pointerInputNode$1$1$1":I
    ...
    .line 207
    .local v11, "requestFocus":Lkotlin/jvm/functions/Function0;
    ...
    .end local v1    # "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    .end local v11    # "requestFocus":Lkotlin/jvm/functions/Function0;
    .local v5, "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    .local v7, "requestFocus":Lkotlin/jvm/functions/Function0;
    invoke-direct/range {v3 .. v8}, Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode$pointerInputNode$1$1$1$2;-><init>(Landroidx/compose/foundation/text/input/internal/TextFieldDecoratorModifierNode;Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;Landroidx/compose/ui/input/pointer/PointerInputScope;Lkotlin/jvm/functions/Function0;Lkotlin/coroutines/Continuation;)V

    move-object v8, v6

    move-object v9, v7

    .end local v5    # "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    .end local v7    # "requestFocus":Lkotlin/jvm/functions/Function0;
    .restart local v1    # "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    .local v9, "requestFocus":Lkotlin/jvm/functions/Function0;
    move-object v5, v3
    ...
    .line 202
    .end local v1    # "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;
    .end local v9    # "requestFocus":Lkotlin/jvm/functions/Function0;
    .end local v10    # "$i$a$-with-TextFieldDecoratorModifierNode$pointerInputNode$1$1$1":I
    nop
