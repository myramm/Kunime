...
.method public final from(Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/text/TextStyle;Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/text/font/FontFamily$Resolver;)Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;
    ...
    .line 74
    :cond_5
    new-instance v4, Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;
    ...
    .local p2, "it":Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;
    const/4 p4, 0x0

    .line 80
    .local p4, "$i$a$-also-MinLinesConstrainer$Companion$from$3":I
    sget-object p5, Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;->Companion:Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer$Companion;

    invoke-static {p2}, Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;->access$setLast$cp(Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;)V

    .line 81
    nop

    .line 79
    .end local p2    # "it":Landroidx/compose/foundation/text/modifiers/MinLinesConstrainer;
    .end local p4    # "$i$a$-also-MinLinesConstrainer$Companion$from$3":I
    nop
