...
.method public draw(Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;)V
    ...
    .line 315
    :goto_0
    iget-object v6, v1, Landroidx/compose/foundation/MarqueeModifierNode;->offset:Landroidx/compose/animation/core/Animatable;
    ...
    .local v13, "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    const/4 v14, 0x0
    ...
    .local v17, "firstCopyVisible":Z
    .local v18, "secondCopyVisible":Z
    ...
    .line 332
    .local v19, "$i$a$-clipRect-rOu3jXo$default-MarqueeModifierNode$draw$1":I
    if-eqz v17, :cond_a
    ...
    .end local v19    # "$i$a$-clipRect-rOu3jXo$default-MarqueeModifierNode$draw$1":I
    :catchall_0
    move-exception v0
    ...
    .restart local v19    # "$i$a$-clipRect-rOu3jXo$default-MarqueeModifierNode$draw$1":I
    :cond_a
    :goto_6
    if-eqz v18, :cond_b
    ...
    .line 542
    .local v20, "$this$translate_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    nop
    ...
    .line 337
    .local v22, "$i$a$-translate$default-MarqueeModifierNode$draw$1$1":I
    :try_start_3
    invoke-interface/range {p1 .. p1}, Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;->drawContent()V
    :try_end_3
    ...
    .end local v22    # "$i$a$-translate$default-MarqueeModifierNode$draw$1$1":I
    nop
    ...
    .end local v3    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .local v22, "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    neg-float v3, v2

    move/from16 v23, v4

    .end local v4    # "clipOffset":F
    ...
    .line 551
    .end local v22    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v23    # "clipOffset":F
    .restart local v3    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v4    # "clipOffset":F
    :catchall_1
    move-exception v0
    ...
    .end local v3    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v4    # "clipOffset":F
    .restart local v22    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    invoke-interface {v3, v4, v0}, Landroidx/compose/ui/graphics/drawscope/DrawTransform;->translate(FF)V

    .end local v2    # "secondCopyOffset":F
    ...
    .end local v12    # "$i$f$clipRect-rOu3jXo":I
    .end local v13    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    .end local v17    # "firstCopyVisible":Z
    .end local v18    # "secondCopyVisible":Z
    .end local v23    # "clipOffset":F
    ...
    .end local v19    # "$i$a$-clipRect-rOu3jXo$default-MarqueeModifierNode$draw$1":I
    .end local v20    # "$this$translate_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .end local v21    # "$i$f$translate":I
    .end local v22    # "$this$draw_u24lambda_u241":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v2    # "secondCopyOffset":F
    .restart local v5    # "top$iv":F
    .restart local v6    # "right$iv":F
    .restart local v7    # "bottom$iv":F
    .restart local v8    # "clipOp$iv":I
    .restart local v9    # "previousSize$iv$iv":J
    .restart local v11    # "$this$clipRect_u2drOu3jXo_u24default$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    .restart local v12    # "$i$f$clipRect-rOu3jXo":I
    .restart local v13    # "$this$withTransform$iv$iv":Landroidx/compose/ui/graphics/drawscope/DrawScope;
    ...
    .restart local v17    # "firstCopyVisible":Z
    .restart local v18    # "secondCopyVisible":Z
    .restart local v23    # "clipOffset":F
    ...
    .line 555
    invoke-interface {v15, v9, v10}, Landroidx/compose/ui/graphics/drawscope/DrawContext;->setSize-uvyYCjk(J)V
