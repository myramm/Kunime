...
.method private sendSuccessToClient(Landroidx/biometric/BiometricPrompt$AuthenticationResult;)V
    ...
    const-string/jumbo v1, "Success not sent to client. Client is not awaiting a result."
...
.method private showFingerprintDialogForAuthentication()V
    ...
    const-string/jumbo v5, "androidx.biometric.FingerprintDialogFragment"
...
.method authenticate(Landroidx/biometric/BiometricPrompt$PromptInfo;Landroidx/biometric/BiometricPrompt$CryptoObject;)V
    ...
    const-string/jumbo v2, "Not launching prompt. Client activity was null."
    ...
    .line 381
    invoke-virtual {v3, v2}, Landroidx/biometric/BiometricViewModel;->setNegativeButtonTextOverride(Ljava/lang/CharSequence;)V
...
.method authenticateWithFingerprint(Landroidx/core/hardware/fingerprint/FingerprintManagerCompat;Landroid/content/Context;)V
    ...
    .line 532
    .local v4, "cancellationSignal":Landroidx/core/os/CancellationSignal;
    iget-object v0, p0, Landroidx/biometric/BiometricFragment;->mViewModel:Landroidx/biometric/BiometricViewModel;
    ...
    .end local p1    # "fingerprintManager":Landroidx/core/hardware/fingerprint/FingerprintManagerCompat;
    .local v1, "fingerprintManager":Landroidx/core/hardware/fingerprint/FingerprintManagerCompat;
    :try_start_0
    ...
    .line 542
    invoke-virtual {p0, v3, v6}, Landroidx/biometric/BiometricFragment;->sendErrorAndDismiss(ILjava/lang/CharSequence;)V
...
.method showPromptForAuthentication()V
    ...
    const-string/jumbo v1, "Not showing biometric prompt. Context is null."
