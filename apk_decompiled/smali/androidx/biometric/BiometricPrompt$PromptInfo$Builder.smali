...
.method public build()Landroidx/biometric/BiometricPrompt$PromptInfo;
    ...
    const-string/jumbo v2, "Negative text must be set and non-empty."
    ...
    const-string/jumbo v2, "Negative text must not be set if device credential authentication is allowed."
    ...
    :cond_4
    :goto_2
    new-instance v3, Landroidx/biometric/BiometricPrompt$PromptInfo;
    ...
    const-string/jumbo v1, "Title must be set and non-empty."
