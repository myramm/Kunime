...
.method private final fillInIntent()V
    ...
    const-string/jumbo v10, "Navigation destination "
    ...
    const-string/jumbo v5, "android-support-nav:controller:deepLinkIds"
    ...
    const-string/jumbo v5, "android-support-nav:controller:deepLinkArgs"
...
.method private final verifyAllDestinations()V
    ...
    const-string/jumbo v6, "Navigation destination "
...
.method public final createTaskStackBuilder()Landroidx/core/app/TaskStackBuilder;
    ...
    const-string/jumbo v1, "create(context).addNextI\u2026rentStack(Intent(intent))"
    ...
    const-string/jumbo v1, "You must call setDestination() or addDestination() before constructing the deep link"
    ...
    const-string/jumbo v1, "You must call setGraph() before constructing the deep link"
...
.method public final setArguments(Landroid/os/Bundle;)Landroidx/navigation/NavDeepLinkBuilder;
    ...
    const-string/jumbo v1, "android-support-nav:controller:deepLinkExtras"
...
.method public final setComponentName(Ljava/lang/Class;)Landroidx/navigation/NavDeepLinkBuilder;
    ...
    const-string/jumbo v0, "activityClass"
...
.method public final setDestination(Ljava/lang/String;)Landroidx/navigation/NavDeepLinkBuilder;
    ...
    const-string/jumbo v0, "destRoute"
