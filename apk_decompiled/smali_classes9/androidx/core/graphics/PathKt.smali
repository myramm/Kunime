...
.method public static final and(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 61
    .local v2, "$this$and_u24lambda_u240":Landroid/graphics/Path;
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$and_u24lambda_u240":Landroid/graphics/Path;
...
.method public static final minus(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 61
    .local v2, "$this$minus_u24lambda_u240":Landroid/graphics/Path;
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$minus_u24lambda_u240":Landroid/graphics/Path;
...
.method public static final or(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .local v1, "p$iv":Landroid/graphics/Path;
    move-object v2, p0

    .local v2, "$this$plus$iv":Landroid/graphics/Path;
    const/4 v3, 0x0
    ...
    .line 63
    .local v5, "$this$plus_u24lambda_u240$iv":Landroid/graphics/Path;
    const/4 v6, 0x0

    .line 62
    .local v6, "$i$a$-apply-PathKt$plus$1$iv":I
    sget-object v7, Landroid/graphics/Path$Op;->UNION:Landroid/graphics/Path$Op;

    invoke-virtual {v5, v1, v7}, Landroid/graphics/Path;->op(Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z

    .line 46
    .end local v1    # "p$iv":Landroid/graphics/Path;
    .end local v2    # "$this$plus$iv":Landroid/graphics/Path;
    .end local v3    # "$i$f$plus":I
    .end local v5    # "$this$plus_u24lambda_u240$iv":Landroid/graphics/Path;
    .end local v6    # "$i$a$-apply-PathKt$plus$1$iv":I
    return-object v4
.end method
...
.method public static final xor(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 61
    .local v2, "$this$xor_u24lambda_u240":Landroid/graphics/Path;
    const/4 v3, 0x0
    ...
    .end local v2    # "$this$xor_u24lambda_u240":Landroid/graphics/Path;
