...
.method public static final fromSlice(Landroid/app/slice/Slice;)Landroidx/credentials/provider/PublicKeyCredentialEntry;
    ...
    .local v22, "icon":Ljava/lang/Object;
    .local v23, "lastUsedTime":Ljava/lang/Object;
    ...
    .line 532
    .local v3, "$i$a$-forEach-PublicKeyCredentialEntry$Api28Impl$fromSlice$1":I
    ...
    .end local v22    # "icon":Ljava/lang/Object;
    .local v5, "icon":Ljava/lang/Object;
    goto :goto_1

    .line 551
    .end local v5    # "icon":Ljava/lang/Object;
    .restart local v22    # "icon":Ljava/lang/Object;
    :cond_7
    ...
    .end local v23    # "lastUsedTime":Ljava/lang/Object;
    .local v5, "lastUsedTime":Ljava/lang/Object;
    goto :goto_1

    .line 555
    .end local v5    # "lastUsedTime":Ljava/lang/Object;
    .restart local v23    # "lastUsedTime":Ljava/lang/Object;
    :cond_9
    ...
    .end local v3    # "$i$a$-forEach-PublicKeyCredentialEntry$Api28Impl$fromSlice$1":I
    nop
    ...
    .line 576
    invoke-virtual {v0, v2, v3}, Landroidx/credentials/provider/BeginGetPublicKeyCredentialOption$Companion;->createFromEntrySlice$credentials_release(Landroid/os/Bundle;Ljava/lang/String;)Landroidx/credentials/provider/BeginGetPublicKeyCredentialOption;
    ...
    const-string v3, "PublicKeyCredEntry"
...
.method public final addToSlice(Landroidx/credentials/provider/PublicKeyCredentialEntry;Landroid/app/slice/Slice$Builder;)V
    ...
    .line 430
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getBeginGetCredentialOption()Landroidx/credentials/provider/BeginGetCredentialOption;

    move-result-object v3

    .line 431
    .local v3, "beginGetCredentialOption":Landroidx/credentials/provider/BeginGetCredentialOption;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getEntryGroupId()Ljava/lang/CharSequence;

    move-result-object v4

    .line 433
    .local v4, "entryGroupId":Ljava/lang/CharSequence;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isDefaultIconPreferredAsSingleProvider()Z
    ...
    .line 434
    .local v5, "isDefaultIconPreferredAsSingleProvider":Z
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getAffiliatedDomain()Ljava/lang/CharSequence;
    ...
    .line 458
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getUsername()Ljava/lang/CharSequence;

    move-result-object v9

    .line 459
    .local v9, "title":Ljava/lang/CharSequence;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getDisplayName()Ljava/lang/CharSequence;

    move-result-object v10

    .line 460
    .local v10, "subtitle":Ljava/lang/CharSequence;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getPendingIntent()Landroid/app/PendingIntent;

    move-result-object v12

    .line 461
    .local v12, "pendingIntent":Landroid/app/PendingIntent;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getTypeDisplayName()Ljava/lang/CharSequence;

    move-result-object v13

    .line 462
    .local v13, "typeDisplayName":Ljava/lang/CharSequence;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getLastUsedTime()Ljava/time/Instant;

    move-result-object v14

    .line 463
    .local v14, "lastUsedTime":Ljava/time/Instant;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->getIcon()Landroid/graphics/drawable/Icon;

    move-result-object v15

    .line 464
    .local v15, "icon":Landroid/graphics/drawable/Icon;
    invoke-virtual {v2}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isAutoSelectAllowed()Z
    ...
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->hasDefaultIcon()Z
    ...
    :cond_2
    :goto_2
    invoke-virtual/range {p1 .. p1}, Landroidx/credentials/provider/PublicKeyCredentialEntry;->isAutoSelectAllowedFromOption()Z
