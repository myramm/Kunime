...
.method public final invoke(Ljava/lang/Object;)Landroidx/compose/ui/text/AnnotatedString;
    ...
    .line 111
    .local v9, "spanStylesOrNull":Ljava/util/List;
    const/4 v1, 0x2
    ...
    .restart local v2    # "saver$iv":Landroidx/compose/runtime/saveable/Saver;
    const/4 v3, 0x0
    ...
    .line 546
    .restart local v8    # "$i$a$-let-SaversKt$restore$1$iv":I
    move-object v10, v2
    ...
    .line 112
    .local v10, "paragraphStylesOrNull":Ljava/util/List;
    nop
    ...
    .line 114
    .local v1, "$i$a$-ifEmpty-SaversKt$AnnotatedStringSaver$2$1":I
    move-object v1, v7

    .end local v1    # "$i$a$-ifEmpty-SaversKt$AnnotatedStringSaver$2$1":I
    :cond_5
    ...
    .line 115
    .local v2, "$i$a$-ifEmpty-SaversKt$AnnotatedStringSaver$2$2":I
    move-object v2, v7

    .end local v2    # "$i$a$-ifEmpty-SaversKt$AnnotatedStringSaver$2$2":I
    :cond_7
    ...
    instance-of v5, v6, Landroidx/compose/ui/text/NonNullValueClassSaver;
    ...
    invoke-interface {v11, v4}, Landroidx/compose/runtime/saveable/Saver;->restore(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v3, v1, v2, v7}, Landroidx/compose/ui/text/AnnotatedString;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
