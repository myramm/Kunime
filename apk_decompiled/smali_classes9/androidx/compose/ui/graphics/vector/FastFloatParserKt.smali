...
.method public static final nextFloat(Ljava/lang/String;II)J
    ...
    .line 644
    .local v32, "yLo$iv":J
    ushr-long v34, v7, v22

    .line 646
    .local v34, "yHi$iv":J
    mul-long v36, v29, v34

    .line 647
    .local v36, "xTimesYHi$iv":J
    mul-long v38, v19, v34

    .line 648
    .local v38, "xTimesYMid$iv":J
    mul-long v40, v29, v32

    .line 649
    .local v40, "yTimesXMid$iv":J
    mul-long v42, v19, v32

    .line 652
    .local v42, "xTimesYLo$iv":J
    nop
    ...
    .line 652
    add-long v44, v40, v44

    .line 654
    and-long v46, v38, v16
    ...
    .line 656
    .local v44, "carry$iv":J
    ushr-long v46, v44, v22

    add-long v46, v36, v46

    ushr-long v48, v38, v22
    ...
    .end local v29    # "xHi$iv":J
    .end local v32    # "yLo$iv":J
    .end local v34    # "yHi$iv":J
    .end local v36    # "xTimesYHi$iv":J
    .end local v38    # "xTimesYMid$iv":J
    .end local v40    # "yTimesXMid$iv":J
    .end local v42    # "xTimesYLo$iv":J
    .end local v44    # "carry$iv":J
    nop
    ...
    and-long v34, v46, v32

    cmp-long v18, v34, v32

    if-eqz v18, :cond_3b

    and-long v32, v46, v32
    ...
    .line 240
    :cond_37
    const-wide v29, -0x10000000000001L

    and-long v20, v20, v29

    .line 242
    const-wide/32 v29, 0x3526a

    move-wide/from16 v34, v7

    .end local v7    # "significandFactor":J
    .local v34, "significandFactor":J
    int-to-long v7, v10
    ...
    .line 251
    .end local v2    # "$i$f$doubleFromBits":I
    ...
    .end local v2    # "value$iv":F
    .end local v3    # "$i$f$pack":I
    .local v25, "value$iv":F
    .local v26, "$i$f$pack":I
    int-to-long v2, v6
    ...
    .line 251
    .end local v25    # "value$iv":F
    .end local v26    # "$i$f$pack":I
    return-wide v2
    ...
    .end local v2    # "value$iv":F
    .end local v3    # "$i$f$pack":I
    .restart local v25    # "value$iv":F
    .restart local v26    # "$i$f$pack":I
    int-to-long v2, v6
    ...
    .line 228
    .end local v18    # "upperBit":I
    .end local v20    # "mantissa":J
    .end local v34    # "significandFactor":J
    .local v3, "upperBit":I
    .local v7, "significandFactor":J
    .local v29, "mantissa":J
    :cond_3b
    ...
    .end local v7    # "significandFactor":J
    .restart local v18    # "upperBit":I
    .restart local v34    # "significandFactor":J
    :goto_22
    invoke-virtual {v0, v1, v6}, Ljava/lang/String;->substring(II)Ljava/lang/String;
