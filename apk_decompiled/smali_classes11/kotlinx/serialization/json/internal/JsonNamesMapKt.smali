...
.method private static final buildDeserializationNamesMap(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;)Ljava/util/Map;
    ...
    .line 34
    .local v2, "strategyForClasses":Lkotlinx/serialization/json/JsonNamingStrategy;
    const/4 v3, 0x0
    ...
    .line 36
    .local v12, "$i$a$-forEach-JsonNamesMapKt$buildDeserializationNamesMap$1":I
    if-eqz v1, :cond_2
    ...
    :goto_3
    invoke-static {v0, p0, v13, v3}, Lkotlinx/serialization/json/internal/JsonNamesMapKt;->buildDeserializationNamesMap$putOrThrow(Ljava/util/Map;Lkotlinx/serialization/descriptors/SerialDescriptor;Ljava/lang/String;I)V
    ...
    .end local v12    # "$i$a$-forEach-JsonNamesMapKt$buildDeserializationNamesMap$1":I
    nop
    ...
    invoke-interface {v2, p0, v3, v5}, Lkotlinx/serialization/json/JsonNamingStrategy;->serialNameForJson(Lkotlinx/serialization/descriptors/SerialDescriptor;ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 44
    .local v5, "nameToPut":Ljava/lang/String;
    if-eqz v5, :cond_7
    ...
    .line 44
    .local v7, "$i$a$-let-JsonNamesMapKt$buildDeserializationNamesMap$2":I
    invoke-static {v0, p0, v6, v3}, Lkotlinx/serialization/json/internal/JsonNamesMapKt;->buildDeserializationNamesMap$putOrThrow(Ljava/util/Map;Lkotlinx/serialization/descriptors/SerialDescriptor;Ljava/lang/String;I)V

    .line 34
    .end local v5    # "nameToPut":Ljava/lang/String;
    .end local v6    # "it":Ljava/lang/String;
    .end local v7    # "$i$a$-let-JsonNamesMapKt$buildDeserializationNamesMap$2":I
    :cond_7
    ...
    .line 46
    .local v3, "$i$a$-ifEmpty-JsonNamesMapKt$buildDeserializationNamesMap$3":I
    invoke-static {}, Lkotlin/collections/MapsKt;->emptyMap()Ljava/util/Map;

    move-result-object v3

    .end local v3    # "$i$a$-ifEmpty-JsonNamesMapKt$buildDeserializationNamesMap$3":I
    goto :goto_5
...
.method private static final buildDeserializationNamesMap$putOrThrow(Ljava/util/Map;Lkotlinx/serialization/descriptors/SerialDescriptor;Ljava/lang/String;I)V
    ...
    .line 22
    invoke-direct {v1, v2}, Lkotlinx/serialization/json/internal/JsonException;-><init>(Ljava/lang/String;)V
...
.method private static final decodeCaseInsensitive(Lkotlinx/serialization/json/Json;Lkotlinx/serialization/descriptors/SerialDescriptor;)Z
    .locals 2
    .param p0, "$this$decodeCaseInsensitive"    # Lkotlinx/serialization/json/Json;
...
.method static final deserializationNamesMap$lambda$3(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;)Ljava/util/Map;
    .locals 1
    .param p0, "$descriptor"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p1, "$this_deserializationNamesMap"    # Lkotlinx/serialization/json/Json;
...
.method public static final getJsonElementName(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;I)Ljava/lang/String;
    .locals 2
    .param p0, "$this$getJsonElementName"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p1, "json"    # Lkotlinx/serialization/json/Json;
    .param p2, "index"    # I
...
.method public static final getJsonNameIndex(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Ljava/lang/String;)I
    ...
    invoke-static {p0, p1, v0}, Lkotlinx/serialization/json/internal/JsonNamesMapKt;->getJsonNameIndexSlowPath(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Ljava/lang/String;)I
...
.method private static final getJsonNameIndexSlowPath(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Ljava/lang/String;)I
    .locals 1
    .param p0, "$this$getJsonNameIndexSlowPath"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p1, "json"    # Lkotlinx/serialization/json/Json;
    .param p2, "name"    # Ljava/lang/String;
...
.method public static final serializationNamesIndices(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Lkotlinx/serialization/json/JsonNamingStrategy;)[Ljava/lang/String;
    .locals 3
    .param p0, "$this$serializationNamesIndices"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p1, "json"    # Lkotlinx/serialization/json/Json;
    .param p2, "strategy"    # Lkotlinx/serialization/json/JsonNamingStrategy;
    ...
    new-instance v2, Lkotlinx/serialization/json/internal/JsonNamesMapKt$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0, p2}, Lkotlinx/serialization/json/internal/JsonNamesMapKt$$ExternalSyntheticLambda1;-><init>(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/JsonNamingStrategy;)V

    invoke-virtual {v0, p0, v1, v2}, Lkotlinx/serialization/json/internal/DescriptorSchemaCache;->getOrPut(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/internal/DescriptorSchemaCache$Key;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
...
.method static final serializationNamesIndices$lambda$4(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/JsonNamingStrategy;)[Ljava/lang/String;
    .locals 4
    .param p0, "$this_serializationNamesIndices"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p1, "$strategy"    # Lkotlinx/serialization/json/JsonNamingStrategy;
...
.method public static final tryCoerceValue(Lkotlinx/serialization/json/Json;Lkotlinx/serialization/descriptors/SerialDescriptor;ILkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)Z
    ...
    .param p1, "descriptor"    # Lkotlinx/serialization/descriptors/SerialDescriptor;
    .param p2, "index"    # I
    .param p3, "peekNull"    # Lkotlin/jvm/functions/Function1;
    .param p4, "peekString"    # Lkotlin/jvm/functions/Function0;
    .param p5, "onEnumCoercing"    # Lkotlin/jvm/functions/Function0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlinx/serialization/json/Json;",
    ...
    .line 143
    .local v4, "enumValue":Ljava/lang/String;
    :cond_2
    invoke-static {v2, p0, v4}, Lkotlinx/serialization/json/internal/JsonNamesMapKt;->getJsonNameIndex(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Ljava/lang/String;)I

    move-result v6

    .line 144
    .local v6, "enumIndex":I
    invoke-virtual {p0}, Lkotlinx/serialization/json/Json;->getConfiguration()Lkotlinx/serialization/json/JsonConfiguration;

    move-result-object v7

    invoke-virtual {v7}, Lkotlinx/serialization/json/JsonConfiguration;->getExplicitNulls()Z
    ...
    .line 150
    .end local v4    # "enumValue":Ljava/lang/String;
    .end local v6    # "enumIndex":I
    .end local v7    # "coerceToNull":Z
    :cond_5
    return v5
.end method
...
.method public static synthetic tryCoerceValue$default(Lkotlinx/serialization/json/Json;Lkotlinx/serialization/descriptors/SerialDescriptor;ILkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;ILjava/lang/Object;)Z
    ...
    .line 131
    sget-object p6, Lkotlinx/serialization/json/internal/JsonNamesMapKt$tryCoerceValue$1;->INSTANCE:Lkotlinx/serialization/json/internal/JsonNamesMapKt$tryCoerceValue$1;
    ...
    .line 133
    .local p6, "$i$f$tryCoerceValue":I
    invoke-interface {p1, p2}, Lkotlinx/serialization/descriptors/SerialDescriptor;->isElementOptional(I)Z

    move-result p7

    .line 134
    .local p7, "isOptional":Z
    invoke-interface {p1, p2}, Lkotlinx/serialization/descriptors/SerialDescriptor;->getElementDescriptor(I)Lkotlinx/serialization/descriptors/SerialDescriptor;

    move-result-object v0

    .line 135
    .local v0, "elementDescriptor":Lkotlinx/serialization/descriptors/SerialDescriptor;
    const/4 v1, 0x1
    ...
    :cond_3
    invoke-static {v0, p0, v2}, Lkotlinx/serialization/json/internal/JsonNamesMapKt;->getJsonNameIndex(Lkotlinx/serialization/descriptors/SerialDescriptor;Lkotlinx/serialization/json/Json;Ljava/lang/String;)I
    ...
    invoke-virtual {v5}, Lkotlinx/serialization/json/JsonConfiguration;->getExplicitNulls()Z
