...
.method public static final addAllBooleans(Lkotlinx/serialization/json/JsonArrayBuilder;Ljava/util/Collection;)Z
    ...
    .local v8, "$i$f$addAll$stub_for_inlining$0":I
    const/4 v9, 0x0

    .line 217
    .local v9, "$i$a$-map-JsonElementBuildersKt$addAll$2":I
    ...
    .end local v8    # "$i$f$addAll$stub_for_inlining$0":I
    .end local v9    # "$i$a$-map-JsonElementBuildersKt$addAll$2":I
...
.method public static final addAllNumbers(Lkotlinx/serialization/json/JsonArrayBuilder;Ljava/util/Collection;)Z
    ...
    .local v8, "$i$f$addAll$stub_for_inlining$1":I
    const/4 v9, 0x0

    .line 227
    .local v9, "$i$a$-map-JsonElementBuildersKt$addAll$3":I
    ...
    .end local v8    # "$i$f$addAll$stub_for_inlining$1":I
    .end local v9    # "$i$a$-map-JsonElementBuildersKt$addAll$3":I
    invoke-interface {v2, v7}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z
...
.method public static final addAllStrings(Lkotlinx/serialization/json/JsonArrayBuilder;Ljava/util/Collection;)Z
    ...
    .local v8, "$i$f$addAll$stub_for_inlining":I
    const/4 v9, 0x0

    .line 207
    .local v9, "$i$a$-map-JsonElementBuildersKt$addAll$1":I
    ...
    .end local v8    # "$i$f$addAll$stub_for_inlining":I
    .end local v9    # "$i$a$-map-JsonElementBuildersKt$addAll$1":I
    invoke-interface {v2, v7}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z
