...
.method public static final decode(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;II)[B
    .locals 1
    .param p0, "$this$decode"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
...
.method public static final decodeIntoByteArray(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;[BIII)I
    .locals 7
    .param p0, "$this$decodeIntoByteArray"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
    ...
    .end local p0    # "$this$decodeIntoByteArray":Lkotlin/io/encoding/Base64;
    .end local p2    # "destination":[B
    .end local p3    # "destinationOffset":I
    .end local p4    # "startIndex":I
    .end local p5    # "endIndex":I
    .local v1, "$this$decodeIntoByteArray":Lkotlin/io/encoding/Base64;
...
.method public static final decodeToByteString(Lkotlin/io/encoding/Base64;Ljava/lang/CharSequence;II)Lkotlinx/io/bytestring/ByteString;
    .locals 2
    .param p0, "$this$decodeToByteString"    # Lkotlin/io/encoding/Base64;
...
.method public static final encode(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;II)Ljava/lang/String;
    .locals 1
    .param p0, "$this$encode"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
    .param p2, "startIndex"    # I
    .param p3, "endIndex"    # I
...
.method public static final encodeIntoByteArray(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;[BIII)I
    .locals 7
    .param p0, "$this$encodeIntoByteArray"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
    .param p2, "destination"    # [B
    .param p3, "destinationOffset"    # I
    .param p4, "startIndex"    # I
    ...
    .end local p0    # "$this$encodeIntoByteArray":Lkotlin/io/encoding/Base64;
    .end local p2    # "destination":[B
    .end local p3    # "destinationOffset":I
    .end local p4    # "startIndex":I
    .end local p5    # "endIndex":I
    .local v1, "$this$encodeIntoByteArray":Lkotlin/io/encoding/Base64;
    .local v3, "destination":[B
    .local v4, "destinationOffset":I
    .local v5, "startIndex":I
    .local v6, "endIndex":I
...
.method public static final encodeToAppendable(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;Ljava/lang/Appendable;II)Ljava/lang/Appendable;
    .locals 1
    .param p0, "$this$encodeToAppendable"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
...
.method public static final encodeToByteArray(Lkotlin/io/encoding/Base64;Lkotlinx/io/bytestring/ByteString;II)[B
    .locals 1
    .param p0, "$this$encodeToByteArray"    # Lkotlin/io/encoding/Base64;
    .param p1, "source"    # Lkotlinx/io/bytestring/ByteString;
    .param p2, "startIndex"    # I
    .param p3, "endIndex"    # I
