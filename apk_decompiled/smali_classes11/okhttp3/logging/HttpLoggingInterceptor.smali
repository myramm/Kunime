...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .local v20, "it":Lokhttp3/MediaType;
    const/16 v19, 0x0

    .line 177
    .local v19, "$i$a$-let-HttpLoggingInterceptor$intercept$1":I
    ...
    .end local v20    # "it":Lokhttp3/MediaType;
    ...
    .end local v20    # "it":Lokhttp3/MediaType;
    .local v5, "it":Lokhttp3/MediaType;
    .restart local v21    # "level":Lokhttp3/logging/HttpLoggingInterceptor$Level;
    ...
    .end local v19    # "$i$a$-let-HttpLoggingInterceptor$intercept$1":I
    nop
    ...
    .line 189
    invoke-direct {v1, v15, v11}, Lokhttp3/logging/HttpLoggingInterceptor;->logHeader(Lokhttp3/Headers;I)V
    ...
    invoke-virtual {v9, v11}, Lokhttp3/RequestBody;->writeTo(Lokio/BufferedSink;)V
    ...
    invoke-interface {v8, v12}, Lokhttp3/logging/HttpLoggingInterceptor$Logger;->log(Ljava/lang/String;)V
    ...
    .local v24, "connection":Lokhttp3/Connection;
    ...
    invoke-interface {v8, v3}, Lokhttp3/logging/HttpLoggingInterceptor$Logger;->log(Ljava/lang/String;)V

    goto :goto_b

    .line 212
    .end local v23    # "requestBody":Lokhttp3/RequestBody;
    .end local v24    # "connection":Lokhttp3/Connection;
    ...
    .restart local v24    # "connection":Lokhttp3/Connection;
    new-instance v9, Ljava/lang/StringBuilder;
    ...
    .end local v17    # "contentLength":J
    .restart local v2    # "contentLength":J
    :cond_14
    move-wide/from16 v17, v2

    .end local v2    # "contentLength":J
    .restart local v17    # "contentLength":J
    ...
    .line 238
    invoke-direct {v1, v3, v7}, Lokhttp3/logging/HttpLoggingInterceptor;->logHeader(Lokhttp3/Headers;I)V
    ...
    .line 251
    .local v7, "gzippedLength":Ljava/lang/Long;
    ...
    invoke-static {v14, v8, v15}, Lkotlin/text/StringsKt;->equals(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v8, v14}, Lokio/GzipSource;-><init>(Lokio/Source;)V
    ...
    .end local v7    # "gzippedLength":Ljava/lang/Long;
    .end local v9    # "tookMs":J
    ...
    .restart local v4    # "source":Lokio/BufferedSource;
    .restart local v5    # "buffer":Ljava/lang/Object;
    .restart local v7    # "gzippedLength":Ljava/lang/Long;
    .restart local v9    # "tookMs":J
    ...
    invoke-virtual {v2, v15}, Lokio/Buffer;->readString(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .local v12, "source":Lokio/BufferedSource;
    invoke-virtual {v5}, Lokio/Buffer;->size()J
    ...
    .end local v12    # "source":Lokio/BufferedSource;
...
.method public final setLevel(Lokhttp3/logging/HttpLoggingInterceptor$Level;)Lokhttp3/logging/HttpLoggingInterceptor;
    ...
    .local v0, "$this$setLevel_u24lambda_u2d0":Lokhttp3/logging/HttpLoggingInterceptor;
    const/4 v1, 0x0
    ...
    .line 136
    .end local v0    # "$this$setLevel_u24lambda_u2d0":Lokhttp3/logging/HttpLoggingInterceptor;
