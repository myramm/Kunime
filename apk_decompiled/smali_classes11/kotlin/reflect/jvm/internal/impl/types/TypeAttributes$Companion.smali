...
.method public static final synthetic access$getIndices(Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes$Companion;)Ljava/util/Collection;
    .locals 1
    .param p0, "$this"    # Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes$Companion;
...
.method public customComputeIfAbsent(Ljava/util/concurrent/ConcurrentHashMap;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)I
    .locals 5
    .param p1, "$this$customComputeIfAbsent"    # Ljava/util/concurrent/ConcurrentHashMap;
    .param p2, "key"    # Ljava/lang/String;
    .param p3, "compute"    # Lkotlin/jvm/functions/Function1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 50
    .local v0, "$i$a$-synchronized-TypeAttributes$Companion$customComputeIfAbsent$1":I
    :try_start_0
    invoke-virtual {p1, p2}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 50
    .local v3, "$i$a$-also-TypeAttributes$Companion$customComputeIfAbsent$1$1":I
    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v4

    invoke-virtual {p1, p2, v4}, Ljava/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .end local v2    # "it":I
    .end local v3    # "$i$a$-also-TypeAttributes$Companion$customComputeIfAbsent$1$1":I
    check-cast v1, Ljava/lang/Integer;

    :cond_0
    const-string v2, "this[key] ?: compute(key\u2026is.putIfAbsent(key, it) }"
    ...
    .line 49
    .end local v0    # "$i$a$-synchronized-TypeAttributes$Companion$customComputeIfAbsent$1":I
    monitor-exit p1
