...
.method public static final asSimpleType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    .locals 3
    .param p0, "$this$asSimpleType"    # Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
...
.method public static final replace(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;Ljava/util/List;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .locals 4
    .param p0, "$this$replace"    # Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .param p3, "newArgumentsForUpperBound"    # Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/jvm/internal/impl/types/KotlinType;",
    ...
    .line 153
    :goto_0
    invoke-static {v0, v1}, Lkotlin/reflect/jvm/internal/impl/types/TypeAttributesKt;->replaceAnnotations(Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;

    move-result-object v0

    .line 158
    .local v0, "newAttributes":Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/KotlinType;->unwrap()Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;

    move-result-object v1

    .line 159
    .local v1, "unwrapped":Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
    ...
    invoke-static {v2, p1, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutionKt;->replace(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    ...
    invoke-static {v3, p3, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutionKt;->replace(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    ...
    .line 158
    .end local v1    # "unwrapped":Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
    :goto_1
    return-object v2

    .line 163
    .restart local v1    # "unwrapped":Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
    :cond_4
...
.method public static final replace(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    .locals 8
    .param p0, "$this$replace"    # Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    .param p1, "newArguments"    # Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lkotlin/reflect/jvm/internal/impl/types/error/ErrorType;->replaceArguments(Ljava/util/List;)Lkotlin/reflect/jvm/internal/impl/types/error/ErrorType;
    ...
    .end local p2    # "newAttributes":Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    .local v1, "newAttributes":Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    .local v3, "newArguments":Ljava/util/List;
