...
.method public static final replaceAnnotations(Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    .locals 3
    .param p0, "$this$replaceAnnotations"    # Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    ...
    .line 134
    .local v0, "it":Lkotlin/reflect/jvm/internal/impl/types/AnnotationsTypeAttribute;
    const/4 v1, 0x0

    .line 128
    .local v1, "$i$a$-let-TypeAttributesKt$replaceAnnotations$withoutAnnotations$1":I
    move-object v2, v0

    check-cast v2, Lkotlin/reflect/jvm/internal/impl/types/TypeAttribute;

    invoke-virtual {p0, v2}, Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;->remove(Lkotlin/reflect/jvm/internal/impl/types/TypeAttribute;)Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;

    move-result-object v0

    .end local v0    # "it":Lkotlin/reflect/jvm/internal/impl/types/AnnotationsTypeAttribute;
    .end local v1    # "$i$a$-let-TypeAttributesKt$replaceAnnotations$withoutAnnotations$1":I
    if-nez v0, :cond_2
    ...
    .line 130
    .local v0, "withoutAnnotations":Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    :cond_2
    ...
    invoke-virtual {v0, v1}, Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;->plus(Lkotlin/reflect/jvm/internal/impl/types/TypeAttribute;)Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
...
.method public static final toDefaultAttributes(Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;
    .locals 7
    .param p0, "$this$toDefaultAttributes"    # Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .end local p0    # "$this$toDefaultAttributes":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .local v2, "$this$toDefaultAttributes":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
