...
.method private final computeNeighbours(Lkotlin/reflect/jvm/internal/impl/types/TypeConstructor;Z)Ljava/util/Collection;
    .locals 4
    .param p1, "$this$computeNeighbours"    # Lkotlin/reflect/jvm/internal/impl/types/TypeConstructor;
    .param p2, "useCompanions"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 112
    .local v1, "$i$a$-let-AbstractTypeConstructor$computeNeighbours$1":I
    iget-object v2, v0, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->supertypes:Lkotlin/reflect/jvm/internal/impl/storage/NotNullLazyValue;

    invoke-interface {v2}, Lkotlin/reflect/jvm/internal/impl/storage/NotNullLazyValue;->invoke()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$Supertypes;

    invoke-virtual {v2}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$Supertypes;->getAllSupertypes()Ljava/util/Collection;
    ...
    .end local v1    # "$i$a$-let-AbstractTypeConstructor$computeNeighbours$1":I
    if-eqz v0, :cond_1
