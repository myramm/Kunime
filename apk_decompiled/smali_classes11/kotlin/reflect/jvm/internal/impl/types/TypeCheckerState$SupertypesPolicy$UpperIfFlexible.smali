...
.method public transformType(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;
    ...
    .line 836
    .local v0, "$this$transformType_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/types/model/TypeSystemContext;
    const/4 v1, 0x0

    .line 173
    .local v1, "$i$a$-with-TypeCheckerState$SupertypesPolicy$UpperIfFlexible$transformType$1":I
    invoke-interface {v0, p2}, Lkotlin/reflect/jvm/internal/impl/types/model/TypeSystemContext;->upperBoundIfFlexible(Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/SimpleTypeMarker;

    move-result-object v0

    .end local v0    # "$this$transformType_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/types/model/TypeSystemContext;
    .end local v1    # "$i$a$-with-TypeCheckerState$SupertypesPolicy$UpperIfFlexible$transformType$1":I
    return-object v0
.end method
