...
.method public collectPackageFragments(Lkotlin/reflect/jvm/internal/impl/name/FqName;Ljava/util/Collection;)V
    ...
    .local v4, "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    const/4 v5, 0x0

    .line 26
    .local v5, "$i$a$-filterTo-PackageFragmentProviderImpl$collectPackageFragments$1":I
    ...
    .line 43
    .end local v4    # "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    .end local v5    # "$i$a$-filterTo-PackageFragmentProviderImpl$collectPackageFragments$1":I
    if-eqz v4, :cond_0
...
.method public getPackageFragments(Lkotlin/reflect/jvm/internal/impl/name/FqName;)Ljava/util/List;
    ...
    .local v7, "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    const/4 v8, 0x0

    .line 34
    .local v8, "$i$a$-filter-PackageFragmentProviderImpl$getPackageFragments$1":I
    invoke-interface {v7}, Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;->getFqName()Lkotlin/reflect/jvm/internal/impl/name/FqName;
    ...
    .line 49
    .end local v7    # "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    .end local v8    # "$i$a$-filter-PackageFragmentProviderImpl$getPackageFragments$1":I
    if-eqz v7, :cond_0
...
.method public getSubPackagesOf(Lkotlin/reflect/jvm/internal/impl/name/FqName;Lkotlin/jvm/functions/Function1;)Ljava/util/Collection;
    ...
    .line 38
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentProviderImpl$getSubPackagesOf$1;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentProviderImpl$getSubPackagesOf$1;
    ...
    .line 39
    new-instance v1, Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentProviderImpl$getSubPackagesOf$2;

    invoke-direct {v1, p1}, Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentProviderImpl$getSubPackagesOf$2;-><init>(Lkotlin/reflect/jvm/internal/impl/name/FqName;)V
...
.method public isEmpty(Lkotlin/reflect/jvm/internal/impl/name/FqName;)Z
    ...
    .local v5, "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    const/4 v6, 0x0

    .line 30
    .local v6, "$i$a$-none-PackageFragmentProviderImpl$isEmpty$1":I
    ...
    .line 46
    .end local v5    # "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    .end local v6    # "$i$a$-none-PackageFragmentProviderImpl$isEmpty$1":I
    if-eqz v5, :cond_1
