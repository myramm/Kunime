...
.method public final createKotlinPackagePartScope(Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;)Lkotlin/reflect/jvm/internal/impl/resolve/scopes/MemberScope;
    ...
    .local v4, "this_$iv":Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;
    const/4 v5, 0x0

    .line 169
    .local v5, "$i$f$parseProto":I
    nop
    ...
    .end local v4    # "this_$iv":Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;
    .end local v5    # "$i$f$parseProto":I
    ...
    .restart local v4    # "this_$iv":Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;
    .restart local v5    # "$i$f$parseProto":I
    ...
    :goto_0
    invoke-direct {v4}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;->getSkipMetadataVersionCheck()Z
    ...
    invoke-direct {v4}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;->getOwnMetadataVersion()Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/JvmMetadataVersion;
    ...
    .line 71
    .local v6, "packageProto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Package;
    new-instance v4, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmPackagePartSource;
    ...
    .end local p2    # "kotlinClass":Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;
    .local v5, "kotlinClass":Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;
    invoke-direct/range {v4 .. v10}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmPackagePartSource;-><init>(Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Package;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/NameResolver;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/IncompatibleVersionErrorData;ZLkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedContainerAbiStability;)V

    .end local v5    # "kotlinClass":Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;
    .restart local p2    # "kotlinClass":Lkotlin/reflect/jvm/internal/impl/load/kotlin/KotlinJvmBinaryClass;
    move-object v1, v4
    ...
    check-cast v9, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedContainerSource;
    ...
    .line 78
    sget-object v5, Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver$createKotlinPackagePartScope$2;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver$createKotlinPackagePartScope$2;
    ...
    .end local p1    # "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    .local v5, "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    ...
    .end local v5    # "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    .restart local p1    # "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/PackageFragmentDescriptor;
    ...
    .end local v6    # "packageProto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Package;
    .local v0, "e$iv":Ljava/lang/Throwable;
    .restart local v4    # "this_$iv":Lkotlin/reflect/jvm/internal/impl/load/kotlin/DeserializedDescriptorResolver;
    .local v5, "$i$f$parseProto":I
    :cond_3
