...
.method public final invoke()Ljava/util/HashMap;
    ...
    const-string v5, "byInternalName(partInternalName)"
    ...
    .line 75
    .local v5, "header":Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader;
    invoke-virtual {v5}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader;->getKind()Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader$Kind;

    move-result-object v6

    sget-object v7, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageFragment$partToFacade$2$WhenMappings;->$EnumSwitchMapping$0:[I

    invoke-virtual {v6}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader$Kind;->ordinal()I
    ...
    invoke-interface {v6, v4, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader;->getMultifileClassName()Ljava/lang/String;
    ...
    const-string v8, "byInternalName(header.mu\u2026: continue@kotlinClasses)"
    ...
    .end local v5    # "header":Lkotlin/reflect/jvm/internal/impl/load/kotlin/header/KotlinClassHeader;
    :goto_1
    goto :goto_0
