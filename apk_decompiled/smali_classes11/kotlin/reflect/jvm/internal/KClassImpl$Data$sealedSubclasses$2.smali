...
.method public final invoke()Ljava/util/List;
    ...
    iget-object v1, v0, Lkotlin/reflect/jvm/internal/KClassImpl$Data$sealedSubclasses$2;->this$0:Lkotlin/reflect/jvm/internal/KClassImpl$Data;
    ...
    invoke-interface {v1}, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;->getSealedSubclasses()Ljava/util/Collection;

    move-result-object v1

    const-string v2, "descriptor.sealedSubclasses"
    ...
    .local v12, "subclass":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    const/4 v13, 0x0

    .line 156
    .local v13, "$i$a$-mapNotNull-KClassImpl$Data$sealedSubclasses$2$1":I
    ...
    invoke-static {v12}, Lkotlin/reflect/jvm/internal/UtilKt;->toJavaClass(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Ljava/lang/Class;

    move-result-object v14

    .line 157
    .local v14, "jClass":Ljava/lang/Class;
    if-eqz v14, :cond_0

    move-object v15, v14

    .line 344
    .local v15, "it":Ljava/lang/Class;
    const/16 v16, 0x0

    .line 157
    .local v16, "$i$a$-let-KClassImpl$Data$sealedSubclasses$2$1$1":I
    new-instance v0, Lkotlin/reflect/jvm/internal/KClassImpl;

    invoke-direct {v0, v15}, Lkotlin/reflect/jvm/internal/KClassImpl;-><init>(Ljava/lang/Class;)V

    .end local v15    # "it":Ljava/lang/Class;
    .end local v16    # "$i$a$-let-KClassImpl$Data$sealedSubclasses$2$1$1":I
    goto :goto_1
    ...
    .line 342
    .end local v12    # "subclass":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    .end local v13    # "$i$a$-mapNotNull-KClassImpl$Data$sealedSubclasses$2$1":I
    .end local v14    # "jClass":Ljava/lang/Class;
    :goto_1
    if-eqz v0, :cond_1
