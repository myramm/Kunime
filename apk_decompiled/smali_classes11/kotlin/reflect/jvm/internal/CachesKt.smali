...
.method private static final getOrCreateKTypeWithTypeArguments(Ljava/lang/Class;Ljava/util/List;Z)Lkotlin/reflect/KType;
    ...
    .line 68
    .local v0, "cache":Ljava/util/concurrent/ConcurrentHashMap;
    move-object v1, v0
    ...
    .line 69
    .local v4, "$i$a$-getOrPut-CachesKt$getOrCreateKTypeWithTypeArguments$1":I
    ...
    invoke-static {v5, p1, p2, v6}, Lkotlin/reflect/full/KClassifiers;->createType(Lkotlin/reflect/KClassifier;Ljava/util/List;ZLjava/util/List;)Lkotlin/reflect/KType;

    move-result-object v4

    .line 76
    .end local v4    # "$i$a$-getOrPut-CachesKt$getOrCreateKTypeWithTypeArguments$1":I
    nop
    ...
    const-string v1, "cache.getOrPut(arguments\u2026lable, emptyList())\n    }"
