...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/util/List;ZZ)V
    ...
    .param p3, "filterByAuthorizedAccounts"    # Z
    .param p4, "linkedServiceId"    # Ljava/lang/String;
    .param p5, "idTokenDepositionScopes"    # Ljava/util/List;
    .param p6, "requestVerifiedPhoneNumber"    # Z
    .param p7, "autoSelectEnabled"    # Z
    ...
    .end local p0    # "this":Lcom/google/android/libraries/identity/googleid/GetGoogleIdOption;
    .end local p1    # "serverClientId":Ljava/lang/String;
    .end local p2    # "nonce":Ljava/lang/String;
    .end local p3    # "filterByAuthorizedAccounts":Z
    .end local p4    # "linkedServiceId":Ljava/lang/String;
    .end local p5    # "idTokenDepositionScopes":Ljava/util/List;
    .end local p6    # "requestVerifiedPhoneNumber":Z
    .end local p7    # "autoSelectEnabled":Z
    ...
    .restart local p0    # "this":Lcom/google/android/libraries/identity/googleid/GetGoogleIdOption;
    .restart local p7    # "autoSelectEnabled":Z
    ...
    .end local p0    # "this":Lcom/google/android/libraries/identity/googleid/GetGoogleIdOption;
    iget-boolean v1, p0, Lcom/google/android/libraries/identity/googleid/GetGoogleIdOption;->zzc:Z

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/google/android/libraries/identity/googleid/GetGoogleIdOption;->zzf:Z
