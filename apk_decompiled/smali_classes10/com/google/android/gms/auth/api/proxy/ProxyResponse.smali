...
.method public constructor <init>(ILandroid/app/PendingIntent;ILandroid/os/Bundle;[B)V
    ...
    .end local p0    # "this":Lcom/google/android/gms/auth/api/proxy/ProxyResponse;
    .end local p1    # "googlePlayServicesStatusCode":I
    .end local p2    # "recoveryAction":Landroid/app/PendingIntent;
    .end local p3    # "statusCode":I
    .end local p4    # "headers":Landroid/os/Bundle;
    .end local p5    # "body":[B
    const/4 v1, 0x1
    ...
    .local v2, "googlePlayServicesStatusCode":I
    .local v3, "recoveryAction":Landroid/app/PendingIntent;
    .local v4, "statusCode":I
    .local v5, "headers":Landroid/os/Bundle;
    .local v6, "body":[B
    .restart local p0    # "this":Lcom/google/android/gms/auth/api/proxy/ProxyResponse;
    ...
    .end local v2    # "googlePlayServicesStatusCode":I
    .end local v3    # "recoveryAction":Landroid/app/PendingIntent;
...
.method public constructor <init>(ILjava/util/Map;[B)V
    ...
    .end local p2    # "headers":Ljava/util/Map;
    .end local p3    # "body":[B
...
.method public static createErrorProxyResponse(ILandroid/app/PendingIntent;ILjava/util/Map;[B)Lcom/google/android/gms/auth/api/proxy/ProxyResponse;
    ...
    .end local p0    # "googlePlayServicesStatusCode":I
    .end local p1    # "recoveryAction":Landroid/app/PendingIntent;
    .end local p2    # "statusCode":I
    .end local p3    # "headers":Ljava/util/Map;
    .end local p4    # "body":[B
    const/4 v1, 0x1
