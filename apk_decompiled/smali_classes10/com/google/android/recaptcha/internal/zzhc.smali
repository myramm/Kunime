...
.method private static final zzb([B)V
    ...
    .line 7
    :pswitch_0
    const-string v3, "ORCAS_VALIDATE_SIGNATURE"

    goto/16 :goto_1

    :pswitch_1
    const-string v3, "ORCAS_FETCH_VERIFICATION_KEY"

    goto/16 :goto_1

    :pswitch_2
    const-string v3, "FETCH_TOKEN_ATTEMPT"

    goto/16 :goto_1

    :pswitch_3
    const-string v3, "ORCAS_SIGNAL_INITIALIZATION"

    goto/16 :goto_1

    :pswitch_4
    const-string v3, "ORCAS_SIGNAL_COLLECTION"
