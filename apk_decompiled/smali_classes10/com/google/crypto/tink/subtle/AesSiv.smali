...
.method private varargs s2v([[B)[B
    ...
    .line 77
    iget-object v1, p0, Lcom/google/crypto/tink/subtle/AesSiv;->cmacForS2V:Lcom/google/crypto/tink/subtle/PrfAesCmac;
    ...
    invoke-virtual {v1, v0, v2}, Lcom/google/crypto/tink/subtle/PrfAesCmac;->compute([BI)[B
    ...
    invoke-virtual {v5, v3, v2}, Lcom/google/crypto/tink/subtle/PrfAesCmac;->compute([BI)[B
    ...
    .line 89
    invoke-static {v1, v0}, Lcom/google/crypto/tink/subtle/Bytes;->xorEnd([B[B)[B
    ...
    .line 91
    :cond_3
    invoke-static {v1}, Lcom/google/crypto/tink/subtle/AesUtil;->cmacPad([B)[B
    ...
    invoke-virtual {v3, v0, v2}, Lcom/google/crypto/tink/subtle/PrfAesCmac;->compute([BI)[B
...
.method public encryptDeterministically([B[B)[B
    ...
    .line 100
    .end local v0    # "aesCtr":Ljavax/crypto/Cipher;
    .end local v1    # "computedIv":[B
    .end local v2    # "ivForJavaCrypto":[B
    .end local v3    # "ctrCiphertext":[B
    :cond_0
    new-instance v0, Ljava/security/GeneralSecurityException;
