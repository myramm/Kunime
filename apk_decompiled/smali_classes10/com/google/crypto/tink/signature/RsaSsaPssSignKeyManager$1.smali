...
.method public getPrimitive(Lcom/google/crypto/tink/proto/RsaSsaPssPrivateKey;)Lcom/google/crypto/tink/PublicKeySign;
    ...
    invoke-direct {v3, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v4, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v5, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v6, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v7, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v8, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v9, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v10, v11, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    .line 79
    .local v2, "privateKey":Ljava/security/interfaces/RSAPrivateCrtKey;
    invoke-virtual {p1}, Lcom/google/crypto/tink/proto/RsaSsaPssPrivateKey;->getPublicKey()Lcom/google/crypto/tink/proto/RsaSsaPssPublicKey;
    ...
    .line 81
    .local v3, "params":Lcom/google/crypto/tink/proto/RsaSsaPssParams;
    ...
    .line 86
    invoke-virtual {v3}, Lcom/google/crypto/tink/proto/RsaSsaPssParams;->getSaltLength()I

    move-result v6

    invoke-direct {v0, v2, v4, v5, v6}, Lcom/google/crypto/tink/subtle/RsaSsaPssSignJce;-><init>(Ljava/security/interfaces/RSAPrivateCrtKey;Lcom/google/crypto/tink/subtle/Enums$HashType;Lcom/google/crypto/tink/subtle/Enums$HashType;I)V
    ...
    invoke-direct {v0, v5, v6}, Ljava/security/spec/RSAPublicKeySpec;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {v0, v5, v6, v7, v8}, Lcom/google/crypto/tink/subtle/RsaSsaPssVerifyJce;-><init>(Ljava/security/interfaces/RSAPublicKey;Lcom/google/crypto/tink/subtle/Enums$HashType;Lcom/google/crypto/tink/subtle/Enums$HashType;I)V

    move-object v6, v0

    .line 100
    .local v6, "verifier":Lcom/google/crypto/tink/subtle/RsaSsaPssVerifyJce;
    :try_start_0
    invoke-static {}, Lcom/google/crypto/tink/signature/RsaSsaPssSignKeyManager;->access$000()[B

    move-result-object v0

    invoke-virtual {v4, v0}, Lcom/google/crypto/tink/subtle/RsaSsaPssSignJce;->sign([B)[B
    ...
    invoke-virtual {v6, v0, v7}, Lcom/google/crypto/tink/subtle/RsaSsaPssVerifyJce;->verify([B[B)V
    :try_end_0
