...
.method private static final deflateTo(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;ZLio/ktor/utils/io/pool/ObjectPool;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 85
    .local v2, "$i$a$-let-DeflaterKt$deflateTo$3":I
    nop
    ...
    .line 94
    .end local v2    # "$i$a$-let-DeflaterKt$deflateTo$3":I
    .end local v3    # "crc":Ljava/util/zip/CRC32;
    .end local v6    # "destination":Lio/ktor/utils/io/ByteWriteChannel;
...
.method static final deflateTo$lambda$2(Ljava/util/zip/Deflater;)Z
    .locals 1
...
.method static final deflateTo$lambda$4(Ljava/util/zip/Deflater;)Z
    .locals 1
    .param p0, "$deflater"    # Ljava/util/zip/Deflater;
...
.method private static final putGzipHeader(Lio/ktor/utils/io/ByteWriteChannel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, v5, Lio/ktor/util/DeflaterKt$putGzipHeader$1;->result:Ljava/lang/Object;
    ...
    iput v1, v5, Lio/ktor/util/DeflaterKt$putGzipHeader$1;->label:I

    const/16 v1, 0x8

    invoke-static {p0, v1, v5}, Lio/ktor/utils/io/ByteWriteChannelOperationsKt;->writeByte(Lio/ktor/utils/io/ByteWriteChannel;BLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 39
    .end local p0    # "$this$putGzipHeader":Lio/ktor/utils/io/ByteWriteChannel;
    .local v1, "$this$putGzipHeader":Lio/ktor/utils/io/ByteWriteChannel;
    :goto_2
    ...
    .end local v1    # "$this$putGzipHeader":Lio/ktor/utils/io/ByteWriteChannel;
    if-ne p0, v8, :cond_3
