...
.method public static final handleToken(Lio/ktor/http/CookieDateBuilder;Ljava/lang/String;)V
    ...
    .line 208
    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getHours()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getMinutes()Ljava/lang/Integer;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getSeconds()Ljava/lang/Integer;
    ...
    :cond_5
    :goto_0
    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getDayOfMonth()Ljava/lang/Integer;
    ...
    :cond_8
    :goto_1
    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getMonth()Lio/ktor/util/date/Month;
    ...
    :cond_b
    invoke-virtual {v0}, Lio/ktor/http/CookieDateBuilder;->getYear()Ljava/lang/Integer;
