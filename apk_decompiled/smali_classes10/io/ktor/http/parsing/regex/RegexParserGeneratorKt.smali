...
.method public static final buildRegexParser(Lio/ktor/http/parsing/Grammar;)Lio/ktor/http/parsing/Parser;
    ...
    .line 11
    .local v2, "groups":Ljava/util/Map;
    const/4 v5, 0x6
    ...
    .end local p0    # "$this$buildRegexParser":Lio/ktor/http/parsing/Grammar;
    .local v1, "$this$buildRegexParser":Lio/ktor/http/parsing/Grammar;
    ...
    .line 13
    .local p0, "expression":Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v2}, Lio/ktor/http/parsing/regex/RegexParser;-><init>(Lkotlin/text/Regex;Ljava/util/Map;)V
...
.method private static final toRegex(Lio/ktor/http/parsing/Grammar;Ljava/util/Map;IZ)Lio/ktor/http/parsing/regex/GrammarRegex;
    ...
    new-instance v9, Lio/ktor/http/parsing/regex/GrammarRegex;

    sget-object v1, Lkotlin/text/Regex;->Companion:Lkotlin/text/Regex$Companion;

    move-object v2, v0

    check-cast v2, Lio/ktor/http/parsing/StringGrammar;

    invoke-virtual {v2}, Lio/ktor/http/parsing/StringGrammar;->getValue()Ljava/lang/String;
    ...
    invoke-direct/range {v9 .. v14}, Lio/ktor/http/parsing/regex/GrammarRegex;-><init>(Ljava/lang/String;IZILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    check-cast v3, Lio/ktor/http/parsing/NamedGrammar;

    invoke-virtual {v3}, Lio/ktor/http/parsing/NamedGrammar;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3, v7}, Lio/ktor/http/parsing/regex/RegexParserGeneratorKt;->add(Ljava/util/Map;Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v4, v5, v9}, Lio/ktor/http/parsing/regex/GrammarRegex;-><init>(Ljava/lang/String;IZ)V
    ...
    invoke-static {v13, v2, v4, v9}, Lio/ktor/http/parsing/regex/RegexParserGeneratorKt;->toRegex(Lio/ktor/http/parsing/Grammar;Ljava/util/Map;IZ)Lio/ktor/http/parsing/regex/GrammarRegex;
    ...
    instance-of v9, v0, Lio/ktor/http/parsing/OrGrammar;
    ...
    invoke-direct {v9, v5, v3, v8}, Lio/ktor/http/parsing/regex/GrammarRegex;-><init>(Ljava/lang/String;IZ)V
    ...
    check-cast v3, Lio/ktor/http/parsing/SimpleGrammar;

    invoke-interface {v3}, Lio/ktor/http/parsing/SimpleGrammar;->getGrammar()Lio/ktor/http/parsing/Grammar;

    move-result-object v3

    move/from16 v4, v16

    invoke-static {v3, v2, v7, v4}, Lio/ktor/http/parsing/regex/RegexParserGeneratorKt;->toRegex(Lio/ktor/http/parsing/Grammar;Ljava/util/Map;IZ)Lio/ktor/http/parsing/regex/GrammarRegex;

    move-result-object v3

    .line 61
    .local v3, "nested":Lio/ktor/http/parsing/regex/GrammarRegex;
    new-instance v9, Lio/ktor/http/parsing/regex/GrammarRegex;
    ...
    invoke-virtual {v3}, Lio/ktor/http/parsing/regex/GrammarRegex;->getRegex()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lio/ktor/http/parsing/regex/GrammarRegex;->getGroupsCount()I
    ...
    .end local v3    # "nested":Lio/ktor/http/parsing/regex/GrammarRegex;
    goto/16 :goto_4
    ...
    const-string v4, "Unsupported simple grammar element: "
    ...
    const-string v4, "Unsupported grammar element: "
