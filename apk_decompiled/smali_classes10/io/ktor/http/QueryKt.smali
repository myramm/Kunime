...
.method private static final appendParam(Lio/ktor/http/ParametersBuilder;Ljava/lang/String;IIIZ)V
    ...
    invoke-static {v7, v9, v0}, Lio/ktor/http/QueryKt;->trimStart(IILjava/lang/CharSequence;)I

    move-result v1

    .line 55
    .local v1, "spaceNameIndex":I
    move-object v0, p1

    check-cast v0, Ljava/lang/CharSequence;

    invoke-static {v1, v9, v0}, Lio/ktor/http/QueryKt;->trimEnd(IILjava/lang/CharSequence;)I
    ...
    invoke-interface {p0, v3, v4}, Lio/ktor/http/ParametersBuilder;->appendAll(Ljava/lang/String;Ljava/lang/Iterable;)V
    ...
    invoke-static {v7, v8, v1}, Lio/ktor/http/QueryKt;->trimStart(IILjava/lang/CharSequence;)I

    move-result v1

    .line 67
    .restart local v1    # "spaceNameIndex":I
    move-object v2, v0

    check-cast v2, Ljava/lang/CharSequence;

    invoke-static {v1, v8, v2}, Lio/ktor/http/QueryKt;->trimEnd(IILjava/lang/CharSequence;)I

    move-result v2

    .line 68
    .local v2, "spaceEqualIndex":I
    if-le v2, v1, :cond_5
    ...
    .end local v1    # "spaceNameIndex":I
    .end local v2    # "spaceEqualIndex":I
    .local v11, "spaceNameIndex":I
    .local v12, "spaceEqualIndex":I
    goto :goto_2

    .line 71
    .end local v11    # "spaceNameIndex":I
    .end local v12    # "spaceEqualIndex":I
    .restart local v1    # "spaceNameIndex":I
    .restart local v2    # "spaceEqualIndex":I
    :cond_3
    move v11, v1
    ...
    .end local v1    # "spaceNameIndex":I
    .end local v2    # "spaceEqualIndex":I
    .restart local v11    # "spaceNameIndex":I
    .restart local v12    # "spaceEqualIndex":I
    ...
    invoke-static {v1, v9, v2}, Lio/ktor/http/QueryKt;->trimStart(IILjava/lang/CharSequence;)I
    ...
    invoke-static {v1, v9, v2}, Lio/ktor/http/QueryKt;->trimEnd(IILjava/lang/CharSequence;)I
    ...
    invoke-interface {p0, v13, v3}, Lio/ktor/http/ParametersBuilder;->append(Ljava/lang/String;Ljava/lang/String;)V
