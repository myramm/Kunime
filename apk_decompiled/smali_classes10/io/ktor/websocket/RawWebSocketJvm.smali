...
.method public constructor <init>(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;JZLkotlin/coroutines/CoroutineContext;Lio/ktor/utils/io/pool/ObjectPool;)V
    ...
    invoke-static {v5, v9, v9, v3, v9}, Lkotlinx/coroutines/channels/ChannelKt;->Channel$default(ILkotlinx/coroutines/channels/BufferOverflow;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Lkotlinx/coroutines/channels/Channel;
    ...
    .local v5, "initialValue$iv":Ljava/lang/Object;
    const/4 v6, 0x0

    .line 101
    .local v6, "$i$f$observable":I
    new-instance v7, Lio/ktor/websocket/RawWebSocketJvm$special$$inlined$observable$1;

    invoke-direct {v7, v5, v0}, Lio/ktor/websocket/RawWebSocketJvm$special$$inlined$observable$1;-><init>(Ljava/lang/Object;Lio/ktor/websocket/RawWebSocketJvm;)V
    ...
    .end local v5    # "initialValue$iv":Ljava/lang/Object;
    .end local v6    # "$i$f$observable":I
    iput-object v7, v0, Lio/ktor/websocket/RawWebSocketJvm;->maxFrameSize$delegate:Lkotlin/properties/ReadWriteProperty;
    ...
    .restart local v5    # "initialValue$iv":Ljava/lang/Object;
    const/4 v6, 0x0

    .line 104
    .restart local v6    # "$i$f$observable":I
    new-instance v7, Lio/ktor/websocket/RawWebSocketJvm$special$$inlined$observable$2;

    invoke-direct {v7, v5, v0}, Lio/ktor/websocket/RawWebSocketJvm$special$$inlined$observable$2;-><init>(Ljava/lang/Object;Lio/ktor/websocket/RawWebSocketJvm;)V
    ...
    .end local v5    # "initialValue$iv":Ljava/lang/Object;
    .end local v6    # "$i$f$observable":I
    iput-object v7, v0, Lio/ktor/websocket/RawWebSocketJvm;->masking$delegate:Lkotlin/properties/ReadWriteProperty;

    .line 61
    new-instance v3, Lio/ktor/websocket/WebSocketWriter;

    invoke-virtual {v0}, Lio/ktor/websocket/RawWebSocketJvm;->getCoroutineContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object v5

    move/from16 v10, p5

    invoke-direct {v3, v1, v5, v10, v8}, Lio/ktor/websocket/WebSocketWriter;-><init>(Lio/ktor/utils/io/ByteWriteChannel;Lkotlin/coroutines/CoroutineContext;ZLio/ktor/utils/io/pool/ObjectPool;)V

    iput-object v3, v0, Lio/ktor/websocket/RawWebSocketJvm;->writer:Lio/ktor/websocket/WebSocketWriter;

    .line 62
    new-instance v3, Lio/ktor/websocket/WebSocketReader;
    ...
    iput-object v3, v0, Lio/ktor/websocket/RawWebSocketJvm;->reader:Lio/ktor/websocket/WebSocketReader;
    ...
    invoke-direct {v3, v0, v9}, Lio/ktor/websocket/RawWebSocketJvm$1;-><init>(Lio/ktor/websocket/RawWebSocketJvm;Lkotlin/coroutines/Continuation;)V
