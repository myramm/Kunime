...
.method public constructor <init>(Lio/ktor/websocket/CloseReason;)V
    ...
    .local v2, "$this$_init__u24lambda_u240":Lkotlinx/io/Sink;
    const/4 v9, 0x0

    .line 90
    .local v9, "$i$a$-buildPacket-Frame$Close$1":I
    invoke-virtual {p1}, Lio/ktor/websocket/CloseReason;->getCode()S

    move-result v3

    invoke-interface {v2, v3}, Lkotlinx/io/Sink;->writeShort(S)V
    ...
    .line 160
    .end local v2    # "$this$_init__u24lambda_u240":Lkotlinx/io/Sink;
    .end local v9    # "$i$a$-buildPacket-Frame$Close$1":I
    nop
