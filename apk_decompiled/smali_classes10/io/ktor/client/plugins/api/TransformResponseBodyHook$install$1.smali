...
.method public final invoke(Lio/ktor/util/pipeline/PipelineContext;Lio/ktor/client/statement/HttpResponseContainer;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->$handler:Lkotlin/jvm/functions/Function5;

    invoke-direct {v0, v1, p3}, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;-><init>(Lkotlin/jvm/functions/Function5;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$0:Ljava/lang/Object;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    iget-object v2, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    ...
    iget-object v1, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$0:Ljava/lang/Object;
    ...
    .local v7, "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    ...
    instance-of v1, v6, Lio/ktor/utils/io/ByteReadChannel;
    ...
    .line 105
    :cond_0
    iget-object v3, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->$handler:Lkotlin/jvm/functions/Function5;

    new-instance v4, Lio/ktor/client/plugins/api/TransformResponseBodyContext;

    invoke-direct {v4}, Lio/ktor/client/plugins/api/TransformResponseBodyContext;-><init>()V
    ...
    iput-object v7, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$1:Ljava/lang/Object;

    const/4 v1, 0x1

    iput v1, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->label:I
    ...
    .line 106
    .end local v2    # "$this$intercept":Lio/ktor/util/pipeline/PipelineContext;
    .end local v7    # "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    ...
    .line 107
    .restart local v2    # "$this$intercept":Lio/ktor/util/pipeline/PipelineContext;
    .restart local v7    # "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    .local p1, "newContent":Ljava/lang/Object;
    :cond_2
    instance-of v3, p1, Lio/ktor/http/content/NullBody;
    ...
    const-string v3, " but expected value of type "
    ...
    .line 108
    .end local v7    # "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    .end local p1    # "newContent":Ljava/lang/Object;
    ...
    .restart local v2    # "$this$intercept":Lio/ktor/util/pipeline/PipelineContext;
    .restart local v7    # "typeInfo":Lio/ktor/util/reflect/TypeInfo;
    .restart local p1    # "newContent":Ljava/lang/Object;
    :cond_4
    :goto_1
    new-instance v3, Lio/ktor/client/statement/HttpResponseContainer;

    invoke-direct {v3, v7, p1}, Lio/ktor/client/statement/HttpResponseContainer;-><init>(Lio/ktor/util/reflect/TypeInfo;Ljava/lang/Object;)V
    ...
    iput-object v5, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$0:Ljava/lang/Object;

    iput-object v5, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->L$1:Ljava/lang/Object;

    const/4 v5, 0x2

    iput v5, p0, Lio/ktor/client/plugins/api/TransformResponseBodyHook$install$1;->label:I
