...
.method public constructor <init>(Lio/ktor/http/Url;Lio/ktor/http/HttpStatusCode;Lio/ktor/util/date/GMTDate;Lio/ktor/util/date/GMTDate;Lio/ktor/http/HttpProtocolVersion;Lio/ktor/util/date/GMTDate;Lio/ktor/http/Headers;Ljava/util/Map;[B)V
    ...
    .param p2, "statusCode"    # Lio/ktor/http/HttpStatusCode;
    .param p3, "requestTime"    # Lio/ktor/util/date/GMTDate;
    .param p4, "responseTime"    # Lio/ktor/util/date/GMTDate;
    .param p5, "version"    # Lio/ktor/http/HttpProtocolVersion;
    .param p6, "expires"    # Lio/ktor/util/date/GMTDate;
    .param p7, "headers"    # Lio/ktor/http/Headers;
    .param p8, "varyKeys"    # Ljava/util/Map;
    .param p9, "body"    # [B
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final copy$ktor_client_core(Ljava/util/Map;Lio/ktor/util/date/GMTDate;)Lio/ktor/client/plugins/cache/storage/CachedResponseData;
    .locals 11
    .param p1, "varyKeys"    # Ljava/util/Map;
    ...
    .end local p1    # "varyKeys":Ljava/util/Map;
    .end local p2    # "expires":Lio/ktor/util/date/GMTDate;
    .local v7, "expires":Lio/ktor/util/date/GMTDate;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, v3, Lio/ktor/client/plugins/cache/storage/CachedResponseData;->url:Lio/ktor/http/Url;
    ...
    iget-object v3, v3, Lio/ktor/client/plugins/cache/storage/CachedResponseData;->varyKeys:Ljava/util/Map;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lio/ktor/client/plugins/cache/storage/CachedResponseData;->varyKeys:Ljava/util/Map;
