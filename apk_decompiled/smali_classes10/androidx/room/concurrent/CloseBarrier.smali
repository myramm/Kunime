...
.method public final block$room_runtime_release()Z
    ...
    .line 54
    .local v1, "$i$a$-synchronized-CloseBarrier$block$1":I
    :try_start_0
    ...
    .end local v1    # "$i$a$-synchronized-CloseBarrier$block$1":I
    monitor-exit p0
    ...
    .restart local v1    # "$i$a$-synchronized-CloseBarrier$block$1":I
    :cond_0
    :try_start_1
...
.method public final close$room_runtime_release()V
    ...
    .line 84
    .local v1, "$i$a$-synchronized-CloseBarrier$close$1":I
    :try_start_0
    iget-object v2, p0, Landroidx/room/concurrent/CloseBarrier;->closeInitiated:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .end local v0    # "$i$f$synchronized":I
    .end local v1    # "$i$a$-synchronized-CloseBarrier$close$1":I
    monitor-exit p0
    ...
    .line 88
    .restart local v0    # "$i$f$synchronized":I
    .restart local v1    # "$i$a$-synchronized-CloseBarrier$close$1":I
    :cond_0
    nop
    ...
    .line 89
    .end local v0    # "$i$f$synchronized":I
    iget-object v1, p0, Landroidx/room/concurrent/CloseBarrier;->blockers:Ljava/util/concurrent/atomic/AtomicInteger;

    .local v1, "$this$loop$iv":Ljava/util/concurrent/atomic/AtomicInteger;
    const/4 v2, 0x0
    ...
    .line 110
    .end local v1    # "$this$loop$iv":Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final unblock$room_runtime_release()V
    ...
    .line 70
    .local v1, "$i$a$-synchronized-CloseBarrier$unblock$1":I
    :try_start_0
    iget-object v2, p0, Landroidx/room/concurrent/CloseBarrier;->blockers:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .end local v1    # "$i$a$-synchronized-CloseBarrier$unblock$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 109
    .restart local v0    # "$i$f$synchronized":I
    .restart local v1    # "$i$a$-synchronized-CloseBarrier$unblock$1":I
    :cond_1
    const/4 v2, 0x0

    .line 71
    .local v2, "$i$a$-check-CloseBarrier$unblock$1$1":I
    :try_start_1
    const-string v3, "Unbalanced call to unblock() detected."

    .end local v2    # "$i$a$-check-CloseBarrier$unblock$1$1":I
