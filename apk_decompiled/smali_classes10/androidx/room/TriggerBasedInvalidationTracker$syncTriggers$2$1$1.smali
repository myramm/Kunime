...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local p0    # "this":Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;
    ...
    .restart local p0    # "this":Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;
    ...
    .local v3, "$i$a$-forEachIndexed-TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1":I
    iget v4, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$2:I

    iget v5, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$1:I

    iget v6, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$0:I

    .local v6, "index$iv":I
    iget-object v7, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$2:Ljava/lang/Object;

    check-cast v7, Landroidx/room/Transactor;

    iget-object v8, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$1:Ljava/lang/Object;

    check-cast v8, Landroidx/room/TriggerBasedInvalidationTracker;

    iget-object v9, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$0:Ljava/lang/Object;
    ...
    .end local v3    # "$i$a$-forEachIndexed-TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1":I
    ...
    .restart local v3    # "$i$a$-forEachIndexed-TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1":I
    iget v4, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$2:I
    ...
    iget-object v3, p0, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->this$0:Landroidx/room/TriggerBasedInvalidationTracker;
    ...
    .end local p0    # "this":Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;
    .local v1, "$i$f$forEachIndexed":I
    .local v3, "this":Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;
    .restart local v9    # "$this$forEachIndexed$iv":[Ljava/lang/Object;
    :goto_0
    if-ge v5, v4, :cond_2
    ...
    .line 311
    .local v12, "$i$a$-forEachIndexed-TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1":I
    nop

    .end local v10    # "observeOp":Landroidx/room/ObservedTableStates$ObserveOp;
    sget-object v13, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    iput-object v9, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$0:Ljava/lang/Object;

    iput-object v8, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$1:Ljava/lang/Object;

    iput-object v7, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->L$2:Ljava/lang/Object;

    iput v11, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$0:I

    iput v5, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$1:I

    iput v4, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->I$2:I

    const/4 v13, 0x2

    iput v13, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->label:I
    ...
    iput v2, v3, Landroidx/room/TriggerBasedInvalidationTracker$syncTriggers$2$1$1;->label:I
    ...
    .line 606
    .end local v12    # "$i$a$-forEachIndexed-TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1":I
    add-int/2addr v5, v2
