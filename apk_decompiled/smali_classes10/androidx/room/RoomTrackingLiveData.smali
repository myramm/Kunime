...
.method private constructor <init>(Landroidx/room/RoomDatabase;Landroidx/room/InvalidationLiveDataContainer;Z[Ljava/lang/String;)V
    ...
    .line 59
    invoke-virtual {v1}, Landroidx/room/RoomDatabase;->getTransactionContext$room_runtime_release()Lkotlin/coroutines/CoroutineContext;
...
.method private final refresh(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :pswitch_0
    iget v3, v0, Landroidx/room/RoomTrackingLiveData$refresh$1;->I$0:I

    .local v3, "computed":Z
    iget-object v6, v0, Landroidx/room/RoomTrackingLiveData$refresh$1;->L$0:Ljava/lang/Object;

    check-cast v6, Landroidx/room/RoomTrackingLiveData;
    ...
    :goto_1
    :try_start_1
    iget-object v8, v6, Landroidx/room/RoomTrackingLiveData;->invalid:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v6, v0}, Landroidx/room/RoomTrackingLiveData;->compute(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v6, "computed":Z
    .local v7, "this":Landroidx/room/RoomTrackingLiveData;
    :goto_2
    nop
    ...
    .line 84
    .end local v7    # "this":Landroidx/room/RoomTrackingLiveData;
    .local v1, "$result":Ljava/lang/Object;
    ...
    .restart local v0    # "$continuation":Lkotlin/coroutines/Continuation;
    .restart local v1    # "$result":Ljava/lang/Object;
    .restart local v3    # "computed":Z
    .restart local v6    # "this":Landroidx/room/RoomTrackingLiveData;
    .local v7, "value":Ljava/lang/Object;
    ...
    .line 91
    invoke-virtual {v6, v7}, Landroidx/room/RoomTrackingLiveData;->postValue(Ljava/lang/Object;)V
    :try_end_3
    ...
    .end local v7    # "value":Ljava/lang/Object;
    :cond_5
    iget-object v7, v6, Landroidx/room/RoomTrackingLiveData;->computing:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .end local v3    # "computed":Z
    :goto_4
    iget-object v3, v6, Landroidx/room/RoomTrackingLiveData;->computing:Ljava/util/concurrent/atomic/AtomicBoolean;
